...
public final class mypresentweather extends javax.swing.JFrame {
  ...
  private void initSynopparameters() {
    ...
    ListModel<String> no_precip_model = new AbstractListModel<String>()
        // jList1.setModel(new javax.swing.AbstractListModel()
        {
          String[] strings = {
            ...
            "phenomena without significance"
          }; // index 9
    ...
    // JOptionPane.showMessageDialog(null, present_weather , "present-weather",
    ...
    if (ww_code.compareTo("") != 0) // nothing was selected before
    {
      ...
      if (int_ww_code >= 0 && int_ww_code <= 49) {
        if (int_ww_code >= 0 && int_ww_code <= 3)
          ...
          jList1.setSelectedIndex(
              5); // squalls or funnel cloud(s) within last hour or at time of obs
        else if (int_ww_code >= 20 && int_ww_code <= 29)
          jList1.setSelectedIndex(
              4); // precipitation, fog or thunderstorm within last hour; not at time of obs
        ...
        if (int_ww_code >= 50 && int_ww_code <= 59) jList2.setSelectedIndex(6); // drizzle
        else if (int_ww_code >= 60 && int_ww_code <= 69) jList2.setSelectedIndex(5); // rain
          ...
          jList2.setSelectedIndex(
              3); // showery precipitation, no thunder at time of obs or during preceding hr
  ...
  private void initComponents() {
    ...
    jList2.addListSelectionListener(
        new javax.swing.event.ListSelectionListener() {
          public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
  ...
  private void OK_button_actionPerformed(
    ...
    /* initialisation */
    // NB checks_ok was set to false in Reset_All_PresentWeather_Vars();
    checks_ok = true;
    ...
    if ((present_weather == null) && (general_weather_condition_selected == true)) {
      ...
      JOptionPane.showMessageDialog(
          null,
          "specific weather condition not selected",
    ...
    if (checks_ok == true) {
      if (present_weather != null) {
        ...
        if (present_weather.equals(ww_0)) ww_code = "00";
        else if (present_weather.equals(ww_1)) ww_code = "01";
        else if (present_weather.equals(ww_2)) ww_code = "02";
        else if (present_weather.equals(ww_3)) ww_code = "03";
        else if (present_weather.equals(ww_4)) ww_code = "04";
        else if (present_weather.equals(ww_5)) ww_code = "05";
        else if (present_weather.equals(ww_6)) ww_code = "06";
        else if (present_weather.equals(ww_7)) ww_code = "07";
        else if (present_weather.equals(ww_9)) ww_code = "09";
        else if (present_weather.equals(ww_10)) ww_code = "10";
        else if (present_weather.equals(ww_11)) ww_code = "11";
        else if (present_weather.equals(ww_12)) ww_code = "12";
        else if (present_weather.equals(ww_13)) ww_code = "13";
        else if (present_weather.equals(ww_14)) ww_code = "14";
        else if (present_weather.equals(ww_15)) ww_code = "15";
        else if (present_weather.equals(ww_16)) ww_code = "16";
        else if (present_weather.equals(ww_17)) ww_code = "17";
        else if (present_weather.equals(ww_18)) ww_code = "18";
        else if (present_weather.equals(ww_19)) ww_code = "19";
        else if (present_weather.equals(ww_20)) ww_code = "20";
        else if (present_weather.equals(ww_21)) ww_code = "21";
        else if (present_weather.equals(ww_22)) ww_code = "22";
        else if (present_weather.equals(ww_23)) ww_code = "23";
        else if (present_weather.equals(ww_24)) ww_code = "24";
        else if (present_weather.equals(ww_25)) ww_code = "25";
        else if (present_weather.equals(ww_26)) ww_code = "26";
        else if (present_weather.equals(ww_27)) ww_code = "27";
        else if (present_weather.equals(ww_28)) ww_code = "28";
        else if (present_weather.equals(ww_29)) ww_code = "29";
        else if (present_weather.equals(ww_30)) ww_code = "30";
        else if (present_weather.equals(ww_31)) ww_code = "31";
        else if (present_weather.equals(ww_32)) ww_code = "32";
        else if (present_weather.equals(ww_33)) ww_code = "33";
        else if (present_weather.equals(ww_34)) ww_code = "34";
        else if (present_weather.equals(ww_35)) ww_code = "35";
        else if (present_weather.equals(ww_36)) ww_code = "36";
        else if (present_weather.equals(ww_37)) ww_code = "37";
        else if (present_weather.equals(ww_38)) ww_code = "38";
        else if (present_weather.equals(ww_39)) ww_code = "39";
        else if (present_weather.equals(ww_40)) ww_code = "40";
        else if (present_weather.equals(ww_41)) ww_code = "41";
        else if (present_weather.equals(ww_42)) ww_code = "42";
        else if (present_weather.equals(ww_43)) ww_code = "43";
        else if (present_weather.equals(ww_44)) ww_code = "44";
        else if (present_weather.equals(ww_45)) ww_code = "45";
        else if (present_weather.equals(ww_46)) ww_code = "46";
        else if (present_weather.equals(ww_47)) ww_code = "47";
        else if (present_weather.equals(ww_48)) ww_code = "48";
        else if (present_weather.equals(ww_49)) ww_code = "49";
        else if (present_weather.equals(ww_50)) ww_code = "50";
        else if (present_weather.equals(ww_51)) ww_code = "51";
        else if (present_weather.equals(ww_52)) ww_code = "52";
        else if (present_weather.equals(ww_53)) ww_code = "53";
        else if (present_weather.equals(ww_54)) ww_code = "54";
        else if (present_weather.equals(ww_55)) ww_code = "55";
        else if (present_weather.equals(ww_56)) ww_code = "56";
        else if (present_weather.equals(ww_57)) ww_code = "57";
        else if (present_weather.equals(ww_58)) ww_code = "58";
        else if (present_weather.equals(ww_59)) ww_code = "59";
        else if (present_weather.equals(ww_60)) ww_code = "60";
        else if (present_weather.equals(ww_61)) ww_code = "61";
        else if (present_weather.equals(ww_62)) ww_code = "62";
        else if (present_weather.equals(ww_63)) ww_code = "63";
        else if (present_weather.equals(ww_64)) ww_code = "64";
        else if (present_weather.equals(ww_65)) ww_code = "65";
        else if (present_weather.equals(ww_66)) ww_code = "66";
        else if (present_weather.equals(ww_67)) ww_code = "67";
        else if (present_weather.equals(ww_68)) ww_code = "68";
        else if (present_weather.equals(ww_69)) ww_code = "69";
        else if (present_weather.equals(ww_70)) ww_code = "70";
        else if (present_weather.equals(ww_71)) ww_code = "71";
        else if (present_weather.equals(ww_72)) ww_code = "72";
        else if (present_weather.equals(ww_73)) ww_code = "73";
        else if (present_weather.equals(ww_74)) ww_code = "74";
        else if (present_weather.equals(ww_75)) ww_code = "75";
        else if (present_weather.equals(ww_76)) ww_code = "76";
        else if (present_weather.equals(ww_77)) ww_code = "77";
        else if (present_weather.equals(ww_78)) ww_code = "78";
        else if (present_weather.equals(ww_79)) ww_code = "79";
        else if (present_weather.equals(ww_80)) ww_code = "80";
        else if (present_weather.equals(ww_81)) ww_code = "81";
        else if (present_weather.equals(ww_82)) ww_code = "82";
        else if (present_weather.equals(ww_83)) ww_code = "83";
        else if (present_weather.equals(ww_84)) ww_code = "84";
        else if (present_weather.equals(ww_85)) ww_code = "85";
        else if (present_weather.equals(ww_86)) ww_code = "86";
        else if (present_weather.equals(ww_87)) ww_code = "87";
        else if (present_weather.equals(ww_88)) ww_code = "88";
        else if (present_weather.equals(ww_89)) ww_code = "89";
        else if (present_weather.equals(ww_90)) ww_code = "90";
        else if (present_weather.equals(ww_91)) ww_code = "91";
        else if (present_weather.equals(ww_92)) ww_code = "92";
        else if (present_weather.equals(ww_93)) ww_code = "93";
        else if (present_weather.equals(ww_94)) ww_code = "94";
        else if (present_weather.equals(ww_95)) ww_code = "95";
        else if (present_weather.equals(ww_96)) ww_code = "96";
        else if (present_weather.equals(ww_97)) ww_code = "97";
        else if (present_weather.equals(ww_98)) ww_code = "98";
        else if (present_weather.equals(ww_99)) ww_code = "99";
        else if (present_weather.equals(ww_not_determined)) ww_code = "//";
        else ww_code = "";
      }
    } // if (checks_ok == true)

    // close if checks ok or if nothing at all was selected
    // if ( (checks_ok == true) || ((present_weather == null) && (general_weather_condition_selected
    // == false)) )
    if (checks_ok == true) {
  ...
  public static final String ww_4 =
      "visibility reduced by smoke, e.g. industrial smoke, volcanic ash, forest fire";
  public static final String ww_5 = "haze";
  public static final String ww_6 =
  ...
  public static final String ww_9 =
      "duststorm or sandstorm within sight at time of observation or during the preceding hour";
  ...
  public static final String ww_12 =
      "shallow fog, more or less continuous (not deeper than 10 metres)";
  ...
  public static final String ww_19 =
      "funnel cloud(s) (tornado cloud or waterspout), at or within sight of station";
  ...
  public static final String ww_30 =
      "duststorm or sandstorm, decreasing last hour, slight or moderate";
  public static final String ww_31 =
      "duststorm or sandstorm, unchanging last hour, slight or moderate";
  public static final String ww_32 =
      "duststorm or sandstorm, increasing last hour, slight or moderate";
  ...
  public static final String ww_40 =
      "fogbank (app. vis. in bank < 0.5 nm) at a distance;not at stat. during last hr";
  ...
  public static final String ww_43 =
      "fog (vis. < 0.5 nm), thinning in last hour, sky not discernible";
  public static final String ww_44 =
      "fog (vis. < 0.5 nm), unchanging in last hour, sky discernible";
  public static final String ww_45 =
      "fog (vis. < 0.5 nm), unchanging in last hour, sky not discernible";
  public static final String ww_46 =
      "fog (vis. < 0.5 nm), beginning or thickening in last hour, sky discernible";
  public static final String ww_47 =
      "fog (vis. < 0.5 nm), beginning or thickening in last hour, sky not discernible";
  ...
  public static final String ww_87 =
      "slight shower(s) of soft or small hail (with or without rain/snow)";
  public static final String ww_88 =
      "moderate or heavy showers of soft or small hail (with or without rain/snow)";
  public static final String ww_89 = "slight showers of hail (with or without rain/snow)";
  public static final String ww_90 =
      "moderate or heavy showers of hail (with or without rain/snow)";
  ...
  public static final String ww_94 =
      "moderate or heavy snow, or rain and snow mixed, or hail; thunder heard";
  public static final String ww_95 =
      "thunderstorm (thunder heard), slight or moderate, without hail";
  ...
  public static final String ww_98 =
      "thunderstorm (thunder heard), combined with duststorm or sandstorm";
  ...
  private final String PRESENTWEATHER_HELP_DIR = "weather.pdf";
