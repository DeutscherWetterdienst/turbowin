  ...
  */
  ...
  private void initComponents() {
    ...
    */ jPanel1 = new DASHBOARD_grafiek_AWS_digital();
        ...
        jPanel3Layout
            ...
            .addGroup(
                ...
                jPanel3Layout
                    ...
                    .addGap(220, 220, 220)
                    .addComponent(
                        jButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
                    .addGap(210, 210, 210)
                    .addComponent(
                        jLabel1,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    jLabel2.setText(
        "--- Pressure MSL = 1 min average at MSL. Pressure read, Temp, RH and SST = 1 min average at sensor height. Wind speed and dir = 10 min average at sensor height. Wind gust = max wind in last 10 min at sensor height ---");
        ...
        jPanel2Layout
            ...
            .addGroup(
                jPanel2Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1175, Short.MAX_VALUE)
                    .addContainerGap()));
  ...
  private void Dashboard_AWS_digital_componentResizedHandler(
    ...
    System.out.println(
        "--- AWS Dashboard digital (jPanel1) size = "
            + DASHBOARD_view_AWS_digital.jPanel1.getSize());
  ...
  private void init_dasboard_AWS_digital_timer() {
    ...
    ActionListener update_dashboard_AWS_digital_action =
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    dashboard_update_AWS_digital_timer =
        new Timer(DELAY_UPDATE_AWS_DIGITAL_SENSOR_LOOP, update_dashboard_AWS_digital_action);
    dashboard_update_AWS_digital_timer.setRepeats(true); // false = only one action
    dashboard_update_AWS_digital_timer.setInitialDelay(
        INITIAL_DELAY_UPDATE_AWS_DIGITAL_SENSOR_LOOP); // time in millisec to wait after timer is
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(DASHBOARD_view_AWS_digital.class.getName())
  ...
  // Custom variables
  private final int DELAY_UPDATE_AWS_DIGITAL_SENSOR_LOOP =
      60000; // 1 min                          // time in millisec to wait after timer is started to
  // fire first event (10 min = 10 * 1000 * 60 * 10 = 600000)
  private final int INITIAL_DELAY_UPDATE_AWS_DIGITAL_SENSOR_LOOP =
