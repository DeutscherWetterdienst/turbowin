...
public class HttpStatusMapper {
  ...
  static {
    ...
    CODE_TO_TEXT.put(
        701,
        "station ID or call sign in the obs not on the email whitelist of this server.<br>"
    ...
    //// start second self defined section (no coordination with server [index_webstart_101.php or
    // index_webstart_fm13.php]) //////
    CODE_TO_TEXT.put(710, "internal error when generating format 101 obs");
    // CODE_TO_TEXT.put(711, "most probably no internet connection available or firewall/scanner is
    // blocking");  // actually IOexception
