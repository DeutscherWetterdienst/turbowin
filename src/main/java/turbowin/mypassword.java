...
public final class mypassword extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jPasswordField1.addActionListener(
  ...
  private void OK_button_actionPerformed(
    ...
    if (("TurboWin " + password.trim()).equals("TurboWin JWS" + dummy)) {
      // JOptionPane.showMessageDialog(null, password, "password ok",
      // JOptionPane.INFORMATION_MESSAGE);
      main_support.password_ok =
          true; // no passwords needed for the coming period (see function: password_timer_task()
      // for the length of the set period)
      main_support.password_timer_task(); // start the timer
    ...
    else // thus password not correct
    {
      JOptionPane.showMessageDialog(
          null, "Password not valid", main.APPLICATION_NAME + " info", JOptionPane.ERROR_MESSAGE);
  ...
  private void Enter_actionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Enter_actionPerformed
    // TODO add your handling code here:
    OK_button_actionPerformed(evt);
