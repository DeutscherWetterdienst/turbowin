...
public final class myicing extends javax.swing.JFrame {
                    ...
                    .addGroup(
                        layout
                            ...
                            .addComponent(
                                ...
                                javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED, 155, Short.MAX_VALUE)
                    .addComponent(
                        jSeparator1,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
  ...
  private void initSynopparameters() {
    //  icing from               radio button     Is code FM13      (Is) code format 101 and AWS
    // (bufr 020033 equivalent)
    //
    //  sea spray                1                1                 8
    //  fog                      2                2                 4
    ...
    // NB if EUCAWS AWS linked (RS232_connection_mode = 3) or format 101 then more "cause of ice
    // accretion" options available
    //
  ...
  private void OK_button_actionPerformed(
    ...
    */
    ...
    } else if (jRadioButton5.isSelected() == true) // icing from spray and rain
    {
      Is_code = "5";
        ...
        == true) // icing from fog and rain (AWS and format 101 only)
    {
      Is_code = "6";
    } else if (jRadioButton14.isSelected()
        == true) // icing from spray and fog and rain (AWS and format 101 only)
    {
      Is_code = "14";
    } else if (jRadioButton6.isSelected() == true) // not determined
    {
    ...
    */
    ...
    // om thickness na bijvoorbeeld 12 ingevuld te hebben weer blanco gemaakt te hebben en ook Rs en
    // Is waren not dtermined
    ...
    if (thickness.trim().equals("") && Is_code.trim().equals("") && Rs_code.trim().equals("")) {
      ...
      if (int_thickness < 0 || int_thickness > 99 || thickness.length() > 2) {
        JOptionPane.showMessageDialog(
            null,
            "ice thickness must be in range 0 - 99 (or blank, but blank only if cause of ice accretion and rate of ice accreation are not determined)",
      ...
      // JOptionPane.showMessageDialog(null, EsEs_code,  main.APPLICATION_NAME + " TEST",
      // JOptionPane.WARNING_MESSAGE);
    }
  ...
  private void Internet_button_actionPerformed(
    ...
    // TODO add your handling code here:
    main.help_mouseClicked(ICING_HELP_DIR);
  ...
  // constants
  private final String ICING_HELP_DIR = "icing.pdf";
