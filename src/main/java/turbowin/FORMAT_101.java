...
//     }
      ...
      //     echter de 1 wordt een ABSENT in de compressed message (dus 1 en "niet aanwezig" dan niet meer van elkaar te onderscheiden) daarom nu:
      ...
      */
      ...
      try (BufferedWriter out = new BufferedWriter(new FileWriter(volledig_path_format_101_input_file)))
      {
