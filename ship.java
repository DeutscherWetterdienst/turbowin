...
public class ship 
{
   ...
   /*                                                                                             */
   /***********************************************************************************************/
   public void draw_general_cargo_ship_II(Graphics2D g2d, double wind_rose_diameter, boolean night_mode) 
   {
      //
      //          (x,y).
      //               
      ...
      for (int i = 0; i < 50; i++) // max 50 hatches
      {
         if (y_hatch + (hatch_length + hatch_intermediate / 2) < dist_origin_bridge)    
         {
            ...
            {
               g2d.setPaint(color_hatches_general_cargo_ship_II);
            }
   ...
   public ship(Color color_white, Color color_black, Color color_deck_passenger_ship, Color color_pool_1, Color color_pool_2, Color color_pool_3, Color color_acc_passenger_ship, Color color_life_boat, Color color_funnel_passenger_ship, 
               Color color_funnel_ferry, Color color_bridge_oil_tanker, Color color_bridge_container_ship, Color color_bridge_ro_ro_ship, Color color_bulk_carrier, Color color_lng_tanks, Color color_deck_lng_tanker, Color color_deck_oil_tanker, 
               Color color_pipes_oil_tanker, Color color_deck, Color color_deck_reefer_ship, Color color_deck_general_cargo_classic, Color color_deck_research_vessel, Color color_crane_research_vessel, Color color_hoist_research_vessel, 
               Color color_cradle_research_vessel, Color color_bridge_research_vessel, Color color_night_crane_research_vessel, Color color_night_hoist_research_vessel, Color color_night_cradle_research_vessel, Color color_deck_general_cargo_ship, 
               Color color_deck_container_ship_II, Color color_deck1_ferry, Color color_deck2_ferry, Color color_deck3_ferry, Color color_deck_ro_ro, Color color_lanes_ro_ro, Color color_hatches_general_cargo_ship, Color color_medium_gray, 
               Color color_container_1, Color color_container_2, Color color_container_3, Color color_container_4, Color color_container_5, Color color_container_6, Color color_container_7, Color color_container_8, Color color_container_9, 
               Color color_container_10, Color color_derricks, Color color_deck_general_cargo_ship_II, Color color_hatches_general_cargo_ship_II, Color color_deck_lng_tanker_II, Color color_bridge_lng_tanker_II) {
   ...
   /*                                                                                             */
   /***********************************************************************************************/
   public void draw_container_ship_II(Graphics2D g2d, double wind_rose_diameter, boolean night_mode) 
   {
      //
      //          (x,y).
      //               
   ...
   /*                                                                                             */
   /***********************************************************************************************/
   public void draw_lng_tanker_II(Graphics2D g2d, double wind_rose_diameter, boolean night_mode) 
   {
      //
      //          (x,y).
      //               
   ...
   */
   ...
   private final Color color_deck_lng_tanker_II;
   ...
   private final Color color_deck_general_cargo_ship_II;         ///////////////////////////////
