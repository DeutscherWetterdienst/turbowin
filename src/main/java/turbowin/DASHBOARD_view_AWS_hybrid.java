...
public class DASHBOARD_view_AWS_hybrid extends javax.swing.JFrame {
  ...
  private void initComponents1() {
    ...
    menuItem21_full_rigged_3.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem21_full_rigged_4.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem21_full_rigged_5.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem21_barque_3.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem21_barque_4.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem21_barque_5.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
  ...
  private void initComponents() {
    ...
    jLabel2.setText(
        "--- Pressure MSL = 1 min median at MSL. Temp, RH, SST = 1 min median at sensor ht. Wind speed and dir = 10 min average at sensor ht. Wind gust = max wind in last 10 min at sensor ht. Speed, Course, Heading = 10 min average ---");
        ...
        jPanel3Layout
            ...
            .addGroup(
                jPanel3Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1225, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanel4Layout
            ...
            .addGroup(
                jPanel4Layout
                    ...
                    .addGap(210, 210, 210)
                    .addComponent(
                        jButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
                    .addGap(210, 210, 210)
                    .addComponent(
                        jLabel1,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
  ...
  private void DASHBOARD_AWS_hybrid_componentResizedHandler(
    ...
    System.out.println(
        "--- AWS Dashboard hybrid (jPanel1) size = " + DASHBOARD_view_AWS_hybrid.jPanel1.getSize());
  ...
  private void init_dasboard_AWS_hybrid_timer() {
    ...
    ActionListener update_dashboard_AWS_hybrid_action =
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    dashboard_update_timer_AWS_hybrid =
        new Timer(DELAY_UPDATE_AWS_HYBRID_SENSOR_LOOP, update_dashboard_AWS_hybrid_action);
    dashboard_update_timer_AWS_hybrid.setRepeats(true); // false = only one action
    dashboard_update_timer_AWS_hybrid.setInitialDelay(
        INITIAL_DELAY_UPDATE_AWS_HYBRID_SENSOR_LOOP); // time in millisec to wait after timer is
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(DASHBOARD_view_AWS_hybrid.class.getName())
  ...
  private final int DELAY_UPDATE_AWS_HYBRID_SENSOR_LOOP =
      60000; // 1 min                          // time in millisec to wait after timer is started to
  // fire first event (10 min = 10 * 1000 * 60 * 10 = 600000)
  private final int INITIAL_DELAY_UPDATE_AWS_HYBRID_SENSOR_LOOP =
