...
public class DASHBOARD_view_AWS_radar extends javax.swing.JFrame {
  ...
  private void save_ship_dashboard_selection() {
    ...
    if (DASHBOARD_view_AWS_radar.deck_color != null) {
      main.ship_deck_color_String =
          Integer.toString(DASHBOARD_view_AWS_radar.deck_color.getRGB()); // save color as String
    }
  ...
  private void initComponents1() {
      ...
      try {
        ...
        try {
          ...
          main.log_turbowin_system_message(
              "[GENERAL] pop-up AWS dashboard: error mouse move for deactivating screensaver ("
                  + e.getCause().toString()
                  + ")");
        }
      } catch (SecurityException ex) {
        main.log_turbowin_system_message(
            "[GENERAL] pop-up AWS dashboard: there is no permission to set the value of the always-on-top property ("
    ...
    if (main.theme_mode.equals(main.THEME_NIMBUS_NIGHT)) {
      ...
      background_color_panel1 =
          jPanel4.getBackground(); // jPanel4 = left panel (but could also be another (site)panel)
    ...
    // NB see below, otherwise if you select Dashboard -> AWS for the second, third or xth time it
  ...
  private void init_dashboard_AWS_radar_timer() {
    ...
    ActionListener update_dashboard_AWS_radar_action =
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    dashboard_update_timer_AWS_radar =
        new Timer(DELAY_UPDATE_AWS_RADAR_SENSOR_LOOP, update_dashboard_AWS_radar_action);
    dashboard_update_timer_AWS_radar.setRepeats(true); // false = only one action
    dashboard_update_timer_AWS_radar.setInitialDelay(
        INITIAL_DELAY_UPDATE_AWS_RADAR_SENSOR_LOOP); // time in millisec to wait after timer is
  ...
  private void initComponents() {
    ...
    jLabel2.setText(
        "--- Wind speed and dir = 10 min average. Wind gust = max wind in last 10 min. MSLP = 1 min median. Press read, Air temp, RH, SST = 1 min median at sensor ht. SOG, COG, Heading = 10 min average ---");
        ...
        jPanel3Layout
            ...
            .addGroup(
                jPanel3Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1189, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanel4Layout
            ...
            .addGroup(
                ...
                jPanel4Layout
                    ...
                    .addGap(210, 210, 210)
                    .addComponent(
                        jButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                    .addGap(210, 210, 210)
                    .addComponent(
                        jLabel1,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
  ...
  private void DASHBOARD_view_radar_componentResizedHandler(
    ...
    System.out.println(
        "--- AWS Dashboard wind radar (jPanel1) size = "
            + DASHBOARD_view_AWS_radar.jPanel1.getSize());
  ...
  private void make_obs_actionPerformed(
    ...
    this.setAlwaysOnTop(
        false); // reset AWS pop-up dashboard option to 'NOT aways on top', otherwise main screen
  ...
  private void Dashboard_view_AWS_radar_windowClosing(
    ...
    // main.dashboard_form_AWS_radar.dispose()]

    // NB flag (boolean) "in_dashboard_pop_up_period" is set in Function:
    // RS422_init_new_aws_data_received_check_timer() [RS232_RS422.java]
    //

    if (main.in_dashboard_pop_up_period == true) {
      main.dashboard_was_manually_closed_in_dashboard_pop_up_period =
          true; // for option pop-up window/dashboard
    } else {
      main.dashboard_was_manually_closed_in_dashboard_pop_up_period =
          false; // for option pop-up window/dashboard
    }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(DASHBOARD_view_AWS_radar.class.getName())
  ...
  private final int DELAY_UPDATE_AWS_RADAR_SENSOR_LOOP =
      60000; // 1 min                 // time in millisec to wait after timer is started to fire
  // first event (10 min = 10 * 1000 * 60 * 10 = 600000)
  private final int INITIAL_DELAY_UPDATE_AWS_RADAR_SENSOR_LOOP =
