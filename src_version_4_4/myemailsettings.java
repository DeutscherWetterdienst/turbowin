...
{        
   ...
   jRadioButton1.setSelected(false);                              // defualt email module (python)
   jRadioButton2.setSelected(false);                              // defualt email module (java-jakarta)
   ...
   jTextField5.setEnabled(false);                                 // defualt, alsways disabled (only for showing the user want will be the subject)
   ...
   */
   ...
   else // custom security mode: not inserted = not activated (NB in custom security mode all email items must be present/set!)
   {
      jRadioButton7.setSelected(false);                            // TLS
      jRadioButton8.setSelected(false);                            // SSL
   ...
   {
      // so if nothing was selected before -> 'default email client' will be set as default for sending the (immt etc) log files
      jRadioButton3.setSelected(true);                            // default email client for logs                      
      jRadioButton4.setSelected(false);                           // custom email client for logs
   }
         ...
         .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               ...
               .addGroup(jPanel2Layout.createSequentialGroup()
                  ...
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                  .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                     .addComponent(jRadioButton3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                     .addComponent(jRadioButton4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
                  .addGap(104, 104, 104))))
      );
