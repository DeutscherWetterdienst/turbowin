 ...
 ////////////////////////////////////////////////// END TESTING ////////////////////////////////////////
   ...
   if (course_ok)
   {
      ...
      switch (main.ship_type_dashboard)
      {
         ...
         case main.LNG_TANKER            : main.myship.draw_lng_tanker(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision, DASHBOARD_view_AWS_hybrid.deck_color); break;
         ...
         case main.CONTAINER_SHIP_2      : main.myship.draw_container_ship_II(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
