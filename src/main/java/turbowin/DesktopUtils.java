...
public class DesktopUtils {
    /**
     * Attempts to open the given URL in a browser using the appropriate method based on the operating system.
     *
     * @param linkUrl the URL to open
     * @param os the operating system (e.g., "LINUX")
     * @return an integer code where 0 indicates success, -1 indicates failure to open, and -2 indicates a browsing error
     */
