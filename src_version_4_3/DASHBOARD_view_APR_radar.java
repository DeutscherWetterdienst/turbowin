...
public class DASHBOARD_view_APR_radar extends javax.swing.JFrame {
   ...
   //public static void initComponents1()        
   {
      ...
      JMenuItem menuItem6_deck_color_brown = new JMenuItem("deck color brown");
      menuItem6.add(menuItem6_deck_color_brown);

      menuItem6_deck_color_brown.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_red_brown = new JMenuItem("deck color red-brown");
      menuItem6.add(menuItem6_deck_color_red_brown);

      menuItem6_deck_color_red_brown.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_red = new JMenuItem("deck color red");
      menuItem6.add(menuItem6_deck_color_red);

      menuItem6_deck_color_red.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_green = new JMenuItem("deck color green");
      menuItem6.add(menuItem6_deck_color_green);

      menuItem6_deck_color_green.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_light_green = new JMenuItem("deck color light-green");
      menuItem6.add(menuItem6_deck_color_light_green);

      menuItem6_deck_color_light_green.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_orange = new JMenuItem("deck color orange");
      menuItem6.add(menuItem6_deck_color_orange);

      menuItem6_deck_color_orange.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_yellow = new JMenuItem("deck color yellow");
      menuItem6.add(menuItem6_deck_color_yellow);

      menuItem6_deck_color_yellow.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_gray_brown = new JMenuItem("deck color gray-brown");
      menuItem6.add(menuItem6_deck_color_gray_brown);

      menuItem6_deck_color_gray_brown.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_gray = new JMenuItem("deck color gray");
      menuItem6.add(menuItem6_deck_color_gray);

      menuItem6_deck_color_gray.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_light_gray = new JMenuItem("deck color light-gray");
      menuItem6.add(menuItem6_deck_color_light_gray);

      menuItem6_deck_color_light_gray.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_dark_gray = new JMenuItem("deck color dark-gray");
      menuItem6.add(menuItem6_deck_color_dark_gray);

      menuItem6_deck_color_dark_gray.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
      ...
      JMenuItem menuItem6_deck_color_blue_gray = new JMenuItem("deck color blue-gray");
      menuItem6.add(menuItem6_deck_color_blue_gray);

      menuItem6_deck_color_blue_gray.addActionListener(new java.awt.event.ActionListener() 
      {
         @Override
         public void actionPerformed(ActionEvent e) 
         {
...
public static int convert_ms_to_bf(int wind_speed)        
{
   ...
   */ private static DASHBOARD_grafiek_APR_radar jPanel1;
   ...
   public static final Color DECK_COLOR_GREEN                              = new Color(0, 100, 70);           // e.g. see draw_general_cargo_ship_II() [ship.java]  
   public static final Color DECK_COLOR_LIGHT_GREEN                        = new Color(0, 204, 102);          // e.g. see draw_general_cargo_ship_II() [ship.java]  
   ...
   //private final Color DECK_COLOR_WHITE        
