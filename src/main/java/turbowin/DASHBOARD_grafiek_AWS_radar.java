...
public class DASHBOARD_grafiek_AWS_radar extends JPanel {
  ...
  public DASHBOARD_grafiek_AWS_radar() {
    ...
    color_wind_rose_additional =
        Color
            .YELLOW; // Color.BLACK;             // BF circles + labels; NORTH,WEST,EAST,SOUTH chars
  ...
  public void paintComponent(Graphics g) {
    ...
    int dist_radar_blocks =
        DASHBOARD_view_AWS_radar.width_AWS_radar_dashboard
            / 70; // distance between the info blocks and the radar screen
    ...
    // font_h = new Font("Monospaced", Font.PLAIN, fontSize_c);                             // Bf
    // description (right info block)
    ...
    if ((DASHBOARD_view_AWS_radar.night_vision == false)
        && (main.dashboard_background_image.compareTo("") != 0)) {
      try {
        // Image img1 = new ImageIcon("C:/Users/marti/OneDrive/Pictures/Saved
        // Pictures/taagborg_1.jpg").getImage();
        ...
        g2d.drawImage(
            ...
            0,
            0,
            img_background.getWidth(null),
            img_background.getHeight(null),
            null);

        // NB "main.dashboard_background_image": saved in Function choose_dashboard_image()
        // [DASHBOARD_view_AWS_radar.java]
      } catch (Exception e) {
    ...
    if (main.date_from_AWS_present && main.time_from_AWS_present) {
      if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("January")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("January", "Jan");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("February")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("February", "Feb");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("March")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("March", "Mar");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("April")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("April", "Apr");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("May")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("May", "May");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("June")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("June", "Jun");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("July")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("July", "Jul");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("August")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("August", "Aug");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("September")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("September", "Sep");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("October")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("October", "Oct");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("November")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("November", "Nov");
      } else if (main_RS232_RS422.dashboard_string_last_update_record_date.contains("December")) {
        short_date =
            main_RS232_RS422.dashboard_string_last_update_record_date.replace("December", "Dec");
      }

      measured_at_line = /*MEASURED_AT  + " " +*/
          short_date + "  " + main_RS232_RS422.dashboard_string_last_update_record_time + " UTC";
    } else {
      measured_at_line = MEASURED_AT + " -";
    }
        ...
        reading_int_longitude_degrees =
            Integer.parseInt(
                reading_longitude.substring(
                    0, pos)); // eg 42 12'N ->  reading_latitude_degrees = 42
      } catch (NumberFormatException ex) {
    ...
    if (main.pressure_sensor_level_from_AWS_present) {
      double reading_pressure_at_height =
          main_RS232_RS422.dashboard_double_last_update_record_sensor_level_pressure_ic; // see:
      // main_RS232_RS422.RS422_update_AWS_dasboard_values()
      if (reading_pressure_at_height > 900.0 && reading_pressure_at_height < 1100.0) {
        pressure_height_line =
            "Press read: " + Double.toString(reading_pressure_at_height) + " hPa";
      }
    }
    ...
    {
      if (main.AWSR) // e.g. OMC-140 but NOT EUCAWS or APR
      {
        ...
        if (((AWSR_system_hour + 1) % Integer.valueOf(main.AWSR_reporting_interval)) == 0) {
          ...
          if (AWSR_minutes_for_upload <= 30) {
            DASHBOARD_view_AWS_radar.jButton1.setEnabled(true);
          } else {
            DASHBOARD_view_AWS_radar.jButton1.setEnabled(false);
          }
        } else {
    ...
    // String wind_rel_line_sensor_height = "REL at ??m*  : " + wind_rel_sub_dir_line + " / " +
    // wind_rel_sub_speed_line;
    String wind_rel_line_sensor_height =
        "REL  at "
            + txt_height_anemometer
            + "m* : "
            + wind_rel_sub_dir_line
            + " / "
            + wind_rel_sub_speed_line;
    ...
    if (main.true_wind_speed_from_AWS_present) {
      int true_wind_speed_reading =
          main_RS232_RS422.dashboard_int_last_update_record_true_wind_speed;
    ...
    // String wind_true_line_sensor_height = "True at ??m* : " + wind_true_sub_dir_line + " / " +
    // wind_true_sub_speed_line;
    String wind_true_line_sensor_height =
        "True at "
            + txt_height_anemometer
            + "m* : "
            + wind_true_sub_dir_line
            + " / "
            + wind_true_sub_speed_line;
    ...
    if (main.true_wind_gust_from_AWS_present) {
      int wind_gust_speed_reading =
          main_RS232_RS422.dashboard_int_last_update_record_true_wind_gust;
    ...
    if (main.true_wind_gust_dir_from_AWS_present) {
      int wind_gust_dir_reading =
          main_RS232_RS422.dashboard_int_last_update_record_true_wind_gust_dir;
      if (wind_gust_dir_reading >= 1
          && wind_gust_dir_reading <= 360) // dir = 0 should be impossible
      {
    ...
    // String wind_gust_line_sensor_height = "Gust at ??m* : " + wind_gust_sub_dir_line + " / " +
    // wind_gust_sub_speed_line;
    String wind_gust_line_sensor_height =
        "Gust at "
            + txt_height_anemometer
            + "m* : "
            + wind_gust_sub_dir_line
            + " / "
            + wind_gust_sub_speed_line;
    ...
    if (main.relative_wind_speed_from_AWS_present) {
      int relative_wind_speed_reading_10m =
          main_RS232_RS422.dashboard_int_last_update_record_relative_wind_speed_10m;
    ...
    if (main.relative_wind_dir_from_AWS_present) {
      ...
      int relative_wind_dir_reading_10m =
          main_RS232_RS422.dashboard_int_last_update_record_relative_wind_dir;
      if (relative_wind_dir_reading_10m >= 1
          && relative_wind_dir_reading_10m <= 360) // dir = 0 should be impossible
      {
    ...
    String wind_relative_line_10m =
        "REL  at 10m**: " + wind_rel_sub_dir_line_10m + " / " + wind_rel_sub_speed_line_10m;

    ///////// wind true at 10 m (e.g. "Wind true at 10m: 100\u00B0 / 12 kts") ///////
    //
    String wind_true_sub_speed_line_10m = "-";
    if (main.true_wind_speed_from_AWS_present) {
      int true_wind_speed_reading_10m =
          main_RS232_RS422.dashboard_int_last_update_record_true_wind_speed_10m;
    ...
    if (main.true_wind_dir_from_AWS_present) {
      // NB wind dir at 10m height is excactly the same as at sensor height !!
      int true_wind_dir_reading_10m =
          main_RS232_RS422.dashboard_int_last_update_record_true_wind_dir;
      if (true_wind_dir_reading_10m >= 1
          && true_wind_dir_reading_10m <= 360) // dir = 0 should be impossible
      {
    ...
    String wind_true_line_10m =
        "True at 10m**: " + wind_true_sub_dir_line_10m + " / " + wind_true_sub_speed_line_10m;

    ///////// wind gust true at 10m ////// e.g. "Wind gust at 10m: 100\u00B0 / 12 kts"
    //
    String wind_gust_sub_speed_line_10m = "-";
    if (main.true_wind_gust_from_AWS_present) {
      int true_wind_gust_reading_10m =
          main_RS232_RS422.dashboard_int_last_update_record_true_wind_gust_10m;
    ...
    if (main.true_wind_gust_dir_from_AWS_present) {
      // NB wind dir at 10m height is excactly the same as at sensor height !!
      int true_wind_gust_dir_reading_10m =
          main_RS232_RS422.dashboard_int_last_update_record_true_wind_gust_dir;
      if (true_wind_gust_dir_reading_10m >= 1
          && true_wind_gust_dir_reading_10m <= 360) // dir = 0 should be impossible
      {
    ...
    String wind_gust_line_10m =
        "Gust at 10m**: " + wind_gust_sub_dir_line_10m + " / " + wind_gust_sub_speed_line_10m;

    //////////// wind rose /////////
    //
    double wind_rose_diameter = 0.0;
    if (DASHBOARD_view_AWS_radar.width_AWS_radar_dashboard
        < DASHBOARD_view_AWS_radar.height_AWS_radar_dashboard) {
      wind_rose_diameter =
          DASHBOARD_view_AWS_radar.width_AWS_radar_dashboard
              / 1.1; // nb width from JPanel1 (center panel)
    } else {
      wind_rose_diameter =
          DASHBOARD_view_AWS_radar.height_AWS_radar_dashboard
              / 1.1; // nb height from JPanel1 (center panel)
    }
    ...
    if (main.ship_deck_color_String.equals("") == false) {
      try {
        DASHBOARD_view_AWS_radar.deck_color =
            new Color(Integer.parseInt(main.ship_deck_color_String), true); // String to Color
      } catch (NumberFormatException e) {
        DASHBOARD_view_AWS_radar.deck_color = null;
      }
    }
    ...
    if (main.ship_tank_color_String.equals("") == false) {
      try {
        DASHBOARD_view_AWS_radar.tank_color =
            new Color(Integer.parseInt(main.ship_tank_color_String), true); // String to Color
      } catch (NumberFormatException e) {
        DASHBOARD_view_AWS_radar.tank_color = null;
      }
    }
    ...
    if (course_ok) {
      ...
      switch (main.ship_type_dashboard) {
        case main.YACHT:
          main.myship.draw_yacht(g2d, wind_rose_diameter, DASHBOARD_view_AWS_radar.night_vision);
          break;
        case main.FULL_RIGGED_3:
          main.myship.draw_tall_ship(
              g2d, wind_rose_diameter, DASHBOARD_view_AWS_radar.night_vision);
          break;
        ...
        case main.RO_RO_SHIP_2:
          main.myship.draw_ro_ro_ship_II(
              g2d, wind_rose_diameter, DASHBOARD_view_AWS_radar.night_vision, relativeLightDir);
          break;
        case main.FERRY:
          main.myship.draw_ferry(g2d, wind_rose_diameter, DASHBOARD_view_AWS_radar.night_vision);
          break;
    ...
    // NB most of the time if relative and true direction are almost the same (on the bow) then
    // relative speed will be higher then true speed
    //   therfore first drawing the relative arrow and then the true arrow. Furtheremore the
    // relative wind arrow is a little bit widther than the true wind arrow
    //
    //
    ...
    wind_dir =
        main_RS232_RS422
            .dashboard_int_last_update_record_relative_wind_dir; // NB wind dir at 10m height is
    // excactly the same as at sensor
    // height !!
    wind_speed = main_RS232_RS422.dashboard_int_last_update_record_relative_wind_speed_10m;
    draw_wind_arrow_radar(
        g2d,
        marker_circle_diameter_2,
        bf_per_class_radius,
        wind_type,
    ...
    wind_dir =
        main_RS232_RS422
            .dashboard_int_last_update_record_true_wind_dir; //  NB wind dir at 10m height is
    // excactly the same as at sensor
    // height !!
    ...
    // System.out.println("+++ DASHBOARD_view_AWS_radar.width_AWS_radar_dashboard = " +
    // DASHBOARD_view_AWS_radar.width_AWS_radar_dashboard);
    draw_info_blocks =
        ((wind_rose_diameter * 2) + (dist_radar_blocks * 2))
            < DASHBOARD_view_AWS_radar
                .width_AWS_radar_dashboard; // all of the center drawing panel (JPanel1)
      ...
      if (beaufort_class <= 12) {
        ...
        switch (beaufort_class) {
          case 0:
            ...
            break;
          case 1:
            line1 = "Ripples with the appearance of";
            ...
            break;
          case 2:
            line1 = "Small wavelets, still short";
            ...
            break;
          case 3:
            line1 = "Large wavelets; crests begin ";
            ...
            break;
          case 4:
            line1 = "Small waves, becoming longer;";
            ...
            break;
          case 5:
            line1 = "Moderate waves, taking a more";
            ...
            break;
          case 6:
            line1 = "Large waves begin to form;";
            ...
            break;
          case 7:
            line1 = "Sea heaps up and white foam";
            ...
            break;
          case 8:
            line1 = "Moderately high waves of";
            ...
            break;
          case 9:
            line1 = "High waves; dense streaks of";
            ...
            break;
          case 10:
            line1 = "Very high waves with long";
            ...
            break;
          case 11:
            line1 = "Exceptionally high waves";
            ...
            break;
          case 12:
            line1 = "The air is filled with foam";
  ...
  private void draw_wind_arrow_radar(
    ...
    if (wind_speed_ok && wind_dir_ok) {
      ...
      //
      double x1_arrow =
          Math.cos(Math.toRadians(wind_dir_reading - (max_arrow_width / 2) - 90))
              * (radius_wind_arrow_max); // -90 because the drawing starts at EAST (90 degr)
      double x2_arrow =
          Math.cos(Math.toRadians(wind_dir_reading + (max_arrow_width / 2) - 90))
              * (radius_wind_arrow_max);
      double x3_arrow =
          Math.cos(Math.toRadians(wind_dir_reading + 0 - 90)) * (radius_wind_arrow_max);

      double y1_arrow =
          Math.sin(Math.toRadians(wind_dir_reading - (max_arrow_width / 2) - 90))
              * (radius_wind_arrow_max);
      double y2_arrow =
          Math.sin(Math.toRadians(wind_dir_reading + (max_arrow_width / 2) - 90))
              * (radius_wind_arrow_max);
      double y3_arrow =
          Math.sin(Math.toRadians(wind_dir_reading + 0 - 90)) * (radius_wind_arrow_max);
      ...
      double x3_arrow_actual =
          Math.cos(Math.toRadians(wind_dir_reading + 0 - 90)) * (radius_wind_arrow_actual);
      ...
      double y3_arrow_actual =
          Math.sin(Math.toRadians(wind_dir_reading + 0 - 90)) * (radius_wind_arrow_actual);
  ...
  private void draw_wind_rose_radar(
    ...
    // int units_start                = (int)(wind_rose_diameter / 2 - 18);       // eg 220 / 2 - 18
    // = 92   // not the 5 and 10 units markers
    int units_end =
        (int)
    ...
    // NB see also: https://docstore.mik.ua/orelly/java-ent/jfc/ch04_04.htm for obtaining area
    // difference (substracting)
      ...
      if (DASHBOARD_view_AWS_radar.night_vision == false) {
        ...
        try {
          ...
          g2d.drawImage(
              ...
              -wind_rose_radius,
              -wind_rose_radius,
              (int) wind_rose_diameter,
              (int) wind_rose_diameter,
              this);
        } catch (IOException ex) {
          System.out.println("+++ Dashboard wind radar background image error (day mode)");
        }
      } else // night
      {
        // g2d.setPaint(color_black);
        ...
        try {
          BufferedImage img =
              ImageIO.read(this.getClass().getResource(main.ICONS_DIRECTORY + image));
          // int w = img.getWidth();
          // int h = img.getHeight();
          int wind_rose_radius = (int) wind_rose_diameter / 2;
          ...
          //        // needed for the opacity filter
          BufferedImage bi =
              new BufferedImage(
                  (int) wind_rose_diameter,
                  (int) wind_rose_diameter,
                  BufferedImage
                      .TYPE_INT_ARGB); // needed for the opacity filter + also scaling to radar
          // circle size
          ...
          System.out.println("+++ Dashboard wind radar background image error (night mode)");
        }
      } // else (night)
  ...
  private Color
      color_fill_block; // not final  // parameter value text blocks left and right of the main wind
  // radar circle
