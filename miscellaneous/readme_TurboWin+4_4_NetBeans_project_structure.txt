...
NOTES
1 Source code python email module: email_tbw.py                               // https://gitlab.com/KNMI-OSS/turbowin/turbowin/-/blob/master/src_python/email_tbw.py
...
2] insert the appropriate values for the following variables [myemailsettings.java] (not necessary for EUCAWS): 
