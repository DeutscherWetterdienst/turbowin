...
public final class myice1 extends javax.swing.JFrame {
  ...
  private void OK_button_actionPerformed(
    ...
    // JOptionPane.showMessageDialog(null, ci_code,  main.APPLICATION_NAME + " test ci_code",
  ...
  private void Internet_button_actionPerformed(
    ...
    main.help_mouseClicked(ICE_HELP_DIR);
  ...
  private void initListComponents() {
    ...
    */
    ...
    //
    ComboBoxModel<String> development_model =
        new DefaultComboBoxModel<String>() {
          String[] strings = {
    ...
    // Ice of land origin
    //
    ComboBoxModel<String> land_model =
        new DefaultComboBoxModel<String>() {
          String[] strings = {
    ...
    //
    ComboBoxModel<String> bearing_model =
        new DefaultComboBoxModel<String>() {
          String[] strings = {
    ...
    //
    ComboBoxModel<String> situation_model =
        new DefaultComboBoxModel<String>() {
          String[] strings = {
  ...
  // constants
  private final String ICE_HELP_DIR = "ice.pdf";
