...
// TODO add your handling code here:
    ...
    private void OK_button_actionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OK_button_actionPerformed
       ...
       */
       ...
       else if ( (Nh.equals(NH_0_8)) && !(h.equals(H_CLOUDLESS)) && !(h.equals(H_GROTER_2500)) && !(h.equals(H_NOT_DETERMINED)) && !(h.equals("")) )
       {
          //JOptionPane.showMessageDialog(null, "If 'amount of Cl (or Cm if Cl not present)' = 0/8 then 'height of base of lowest cloud' must be 'cloudless' or '>= 2500 m' or 'not determined'",  main.APPLICATION_NAME + " error", JOptionPane.WARNING_MESSAGE);
          JOptionPane.showMessageDialog(null, "If 'amount of Cl (or Cm if Cl not present)' = 0/8 then 'height of base of lowest cloud' cannot be " + h,  main.APPLICATION_NAME + " error", JOptionPane.WARNING_MESSAGE);
          Reset_All_Cloudcover_Vars();       
       }
