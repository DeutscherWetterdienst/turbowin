...
public class mymaintenancedata extends javax.swing.JFrame {

  /** Creates new form mymaintenancedata */
  public mymaintenancedata() {
    initComponents();
    initComponents2();
  }
        ...
        layout
            ...
            .addGroup(
                layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 769, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        layout
            ...
            .addGroup(
                ...
                layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 489, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        new SwingWorker<String, Void>() {
          ...
          protected String doInBackground() throws Exception {
            ...
            try (BufferedWriter out =
                new BufferedWriter(new FileWriter(maintenance_data_export_file))) {
              for (int i = 0; i < main.MAX_AANTAL_CONFIGURATIEREGELS; i++) {
                if ((main.configuratie_regels[i] != null)
                    && (main.configuratie_regels[i].compareTo("") != 0)) {
              ...
              export_maintenance_data_ok =
                  "OK, maintenance data written to: " + maintenance_data_export_file;

            } // try
            catch (IOException ex) {
              export_maintenance_data_ok =
                  "Unable to write to: " + maintenance_data_export_file + " (" + ex + ")";
            } // catch
      ...
      new SwingWorker<String, Void>() {
        ...
        protected String doInBackground() throws Exception {
          ...
          try (BufferedReader in =
              new BufferedReader(new FileReader(maintenance_data_import_file))) {
            teller = 0;
            ...
            import_maintenance_data_ok =
                "Error reading import file (" + maintenance_data_import_file + ")";
          } // catch
          ...
          if (ship_name_txt_present && call_sign_txt_present) {
            ...
            // user feedback string
            import_maintenance_data_ok =
                "OK, maintenance data successfully importend from: " + maintenance_data_import_file;

          } //    if (ship_name_present && call_sign_present)
          else {
            import_maintenance_data_ok =
                "Invalid format import file (" + maintenance_data_import_file + ")";
          }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(mymaintenancedata.class.getName())
  ...
  private String maintenance_data_import_file =
      ""; // for importing maintenance data (configuration data) from import file
  private String maintenance_data_export_file =
      ""; // for exporting maintenance data (configuration data) to exportt file
}
