            ...
            protected Void doInBackground() throws Exception
            {
               ...
               if ( (Desktop.isDesktopSupported()) && ((main.logs_dir != null) && (main.logs_dir.compareTo("") != 0)) /*&& (main.offline_mode == false)*/ )
               {
                  ...
                  try
                  {
                     ...
                     // make the leaflet maps html file
                     //
...
*/
   ...
   {
      // called from: OK_button_actionPerformed() [myposition.java]
     ...
     if (!main.leaflet_maps_obs_sst.equals(""))
      ...
      {
         String info = "[GENERAL] unable to create dynamic html file for leaflet maps plot (" + e + ")";
...
*/
   ...
   public static double COG_APR_wind            = Double.MAX_VALUE; // used for "APR + FM13" (APR COG is based on 3 hrs if FM13, so extra 10 min COG for wind necessary)
