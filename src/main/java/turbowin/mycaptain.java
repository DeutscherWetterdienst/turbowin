...
public final class mycaptain extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jLabel1.setText(
        "*e.g. M.F.C.M.D.                **format DD/MM/YYYY                 ***discharge book or seaman's card number if applicable");
    ...
    jLabel3.setText(
        "--- to clear this table select: Maintenance --> Move log files  (do not delete data in individual cells) ---");
        ...
        layout
            ...
            .addGroup(
                ...
                layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jSeparator1, javax.swing.GroupLayout.DEFAULT_SIZE, 780, Short.MAX_VALUE)
                    .addContainerGap())
            .addGroup(
                layout
                    .createSequentialGroup()
                    ...
                    .addGroup(
                        layout
                            ...
                            .addComponent(
                                ...
                                Short.MAX_VALUE)
                            .addComponent(
                                jLabel1, javax.swing.GroupLayout.DEFAULT_SIZE, 766, Short.MAX_VALUE)
                            .addGroup(
                                layout
                                    .createSequentialGroup()
                                    .addGap(50, 50, 50)
  ...
  private void initComponents2() {
    ...
    if (main.recruiting_country.indexOf("GERMANY") != -1) {
      ...
      jLabel1.setText(
          "*e.g. Maximilian Louis Leon                                        **discharge book or seaman's card number if applicable");
    } // if (main.recruiting_country.indexOf("Germany") != -1)
  ...
  private void OK_button_actionPerformed(
    ...
    for (int r = 0; r < CAPTAIN_ROWS; r++) {
      ...
      if ((hulp_date_of_joining.length() > 0)
          && (hulp_date_of_joining.compareTo("-") != 0)
          && (hulp_date_of_joining.length() != 10)) {
        JOptionPane.showMessageDialog(
            null,
            "format date of joining must be DD/MM/YYYY, updated data not saved",
      ...
      if (doorgaan && hulp_date_of_joining.length() == 10) {
        if ((hulp_date_of_joining.substring(2, 3).compareTo("/") != 0)
            || (hulp_date_of_joining.substring(5, 6).compareTo("/") != 0)) {
          JOptionPane.showMessageDialog(
              null,
              "format date of joining must be DD/MM/YYYY, updated data not saved",
              main.APPLICATION_NAME + " error",
    ...
    if (doorgaan) {
      ...
      for (int r = 0; r < CAPTAIN_ROWS; r++) {
        ...
        if ((hulp_date_of_leaving.length() > 0)
            && (hulp_date_of_leaving.compareTo("-") != 0)
            && (hulp_date_of_leaving.length() != 10)) {
          JOptionPane.showMessageDialog(
              null,
              "format date of leaving must be DD/MM/YYYY, updated data not saved",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
          doorgaan = false;
        }
        ...
        if (doorgaan && hulp_date_of_leaving.length() == 10) {
          if ((hulp_date_of_leaving.substring(2, 3).compareTo("/") != 0)
              || (hulp_date_of_leaving.substring(5, 6).compareTo("/") != 0)) {
            JOptionPane.showMessageDialog(
                null,
                "format date of leaving must be DD/MM/YYYY, updated data not saved",
                main.APPLICATION_NAME + " error",
  ...
  private void Internet_button_actionPerformed(
    ...
    // TODO add your handling code here:
    main.help_mouseClicked(CAPTAIN_HELP_DIR);
  ...
  private final String CAPTAIN_HELP_DIR = "captain.pdf";

  // scope this module + myturbowin.java main module (all of type: static)
  public static String[][] captain_data =
      new String[CAPTAIN_ROWS][CAPTAIN_COLUMNS]; // default values: null
}
