...
final public class mybarograph extends javax.swing.JFrame {
   ...
   private void initImages()
   {
      ...
      if (os.equals("LINUX"))
      {
         ...
         loadImage_straight(main.ICONS_DIRECTORY + "A_0.jpg"); // nummers alleen omdat een string comment door loadimage en verder aangegeven is, heeft hier verder geen nut
   ...
   private void initSynopparameters() 
   {
      ...
      {
         RS232_mintaka.RS232_Mintaka_Duo_Read_Sensor_Data_a_ppp_Data_Files_For_Obs();       // this function will set 'pressure_amount_tendency' and 'a_code'
      }
      else if (main.RS232_connection_mode == 5 ||main.RS232_connection_mode == 6)           // Mintaka Star USB or Mintaka Sar WiFi connected
      {
         boolean StarX = false;
         RS232_mintaka.RS232_Mintaka_Star_And_StarX_Read_Sensor_Data_a_ppp_Data_Files_For_Obs(StarX);   // this function will set 'pressure_amount_tendency' and 'a_code'
      }
      ...
      {
         RS232_vaisala.RS232_Read_Sensor_Data_a_ppp_For_Obs();                           // this function will set 'pressure_amount_tendency' and 'a_code'
      }
...
private void next_screen()
{
   ...
   public final static String BAROGRAAF_HELP_DIR        = "barograph.pdf";
