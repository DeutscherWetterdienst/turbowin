 ...
 ////////////////////////////////////////////////// END TESTING ////////////////////////////////////////
      ...
      if (course_ok)
      {
         ...
         switch (main.ship_type_dashboard)
         {
            ...
            case main.GENERAL_CARGO_SHIP_2  : main.myship.draw_general_cargo_ship_II(g2d, wind_rose_diameter, DASHBOARD_view_AWS_radar.night_vision); break;
            case main.LNG_TANKER_II         : main.myship.draw_lng_tanker_II(g2d, wind_rose_diameter, DASHBOARD_view_AWS_radar.night_vision); break;
