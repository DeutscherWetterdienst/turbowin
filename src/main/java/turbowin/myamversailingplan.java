...
public final class myamversailingplan extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jTable1.setModel(
        new javax.swing.table.DefaultTableModel(
            ...
            new String[] {
              "route",
              "method [RL,GC,COASTAL]",
              "speed* [knots e.g. 09.8]",
              "lat** [dd-mm N/S]",
              "lon** [ddd-mm W/E]",
              "ETA [day]",
              "ETA [hh:mm]",
    ...
    jLabel25.setText(
        "* optional    ** of the next turning point   *** only required if lay over                        --- all times in UTC ---");
    ...
    jLabel38.setText("--- import saved SP ---");
        ...
        layout
            ...
            .addGroup(
                ...
                layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)
                    .addGap(18, 18, 18)
                    .addComponent(
                        jPanel2,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
  ...
  private void Reset_All_AMVER_SP_Vars() {
    ...
    for (int r = 0; r < AMVER_TRACK_ROWS; r++) {
      for (int c = 1;
          c < AMVER_TRACK_COLUMNS;
          c++) // NB c = 0 predefined (non editable) track numbers
      {
  ...
  private void OK_button_actionPerformed(
    ...
    //       But we want it to stop if the user click the OK button, if fuction stopCellEditing() is
    // not called
  ...
  private void read_sp_data_from_amver_form() {
    ...
    // C-line
    if ((main.amver_report.equals(main.AMVER_DR)) || (main.amver_report.equals(main.AMVER_PR))) {
    ...
    if ((main.amver_report.equals(main.AMVER_SP))
        ...
        || // I-line
        (main.amver_report.equals(main.AMVER_PR))
        || // I-line (note optional for Position Report)
    ...
    if ((main.amver_report.equals(main.AMVER_SP)) || (main.amver_report.equals(main.AMVER_DR))) {
      for (int r = 0; r < AMVER_TRACK_ROWS; r++) {
  ...
  private void check_and_clipboard_email_amver_report(boolean invoke_email_program) {
    ...
    if ((main.amver_report.equals(main.AMVER_SP))
      ...
      if ((checks_ok) && (amver_sp_call_sign.length() < 2)) {
        JOptionPane.showMessageDialog(
            null,
            "call sign not present or invalid",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok) && (amver_sp_imo_number.length() < 2)) {
        JOptionPane.showMessageDialog(
            null,
            "IMO number not present or invalid",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
    ...
    if ((main.amver_report.equals(main.AMVER_SP))
      ...
      if ((checks_ok) && (amver_sp_time_of_dep_day.length() != 2)) {
        if (main.amver_report.equals(main.AMVER_SP)) {
          JOptionPane.showMessageDialog(
              null,
              "day (time of departure) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "day (time of position) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
      ...
      if ((checks_ok) && (amver_sp_time_of_dep_hour.length() != 2)) {
        if (main.amver_report.equals(main.AMVER_SP)) {
          JOptionPane.showMessageDialog(
              null,
              "hour (time of departure) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "hour (time of position) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
      ...
      if ((checks_ok) && (amver_sp_time_of_dep_minute.length() != 2)) {
        if (main.amver_report.equals(main.AMVER_SP)) {
          JOptionPane.showMessageDialog(
              null,
              "minute (time of departure) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "minute (time of position) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
      ...
      if ((checks_ok) && (!month_3_letter_array.contains(amver_sp_time_of_dep_month))) {
        if (main.amver_report.equals(main.AMVER_SP)) {
          JOptionPane.showMessageDialog(
              null,
              "month (time of departure) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "month (time of position) invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
    ...
    if ((main.amver_report.equals(main.AMVER_DR)) || (main.amver_report.equals(main.AMVER_PR))) {
      ...
      if ((checks_ok) && (amver_dr_current_pos_lat.length() != 7)) {
        JOptionPane.showMessageDialog(
            null,
            "current position latitude invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok)
          && ((amver_dr_current_pos_lat.substring(2, 3).compareTo("-") != 0)
              || (amver_dr_current_pos_lat.substring(5, 6).compareTo(" ") != 0)
              || (amver_dr_current_pos_lat.substring(6, 7).compareTo("N") != 0)
                  && (amver_dr_current_pos_lat.substring(6, 7).compareTo("S") != 0))) {
        JOptionPane.showMessageDialog(
            null,
            "current position latutide invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok) && (amver_dr_current_pos_lon.length() != 8)) {
        JOptionPane.showMessageDialog(
            null,
            "current position longitude invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok)
          && ((amver_dr_current_pos_lon.substring(3, 4).compareTo("-") != 0)
              || (amver_dr_current_pos_lon.substring(6, 7).compareTo(" ") != 0)
              || (amver_dr_current_pos_lon.substring(7, 8).compareTo("W") != 0)
                  && (amver_dr_current_pos_lon.substring(7, 8).compareTo("E") != 0))) {
        JOptionPane.showMessageDialog(
            null,
            "current position longitude invalid format",
            main.APPLICATION_NAME + " error",
    ...
    if ((main.amver_report.equals(main.AMVER_SP))
      ...
      if ((checks_ok) && (amver_sp_remainder_speed.length() != 4)) {
        JOptionPane.showMessageDialog(
            null,
            "speed (remainder voyage) invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
    ...
    if (main.amver_report.equals(main.AMVER_SP)) {
      ...
      if ((checks_ok) && (amver_sp_port_dep_name.length() < 2)) {
        JOptionPane.showMessageDialog(
            null,
            "port of depature name not present",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok) && (amver_sp_port_dep_lat.length() != 7)) {
        JOptionPane.showMessageDialog(
            null,
            "port of depature latitude invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok)
          && ((amver_sp_port_dep_lat.substring(2, 3).compareTo("-") != 0)
              || (amver_sp_port_dep_lat.substring(5, 6).compareTo(" ") != 0)
              || (amver_sp_port_dep_lat.substring(6, 7).compareTo("N") != 0)
                  && (amver_sp_port_dep_lat.substring(6, 7).compareTo("S") != 0))) {
        JOptionPane.showMessageDialog(
            null,
            "port of departure latutide invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok) && (amver_sp_port_dep_lon.length() != 8)) {
        JOptionPane.showMessageDialog(
            null,
            "port of depature longitude invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok)
          && ((amver_sp_port_dep_lon.substring(3, 4).compareTo("-") != 0)
              || (amver_sp_port_dep_lon.substring(6, 7).compareTo(" ") != 0)
              || (amver_sp_port_dep_lon.substring(7, 8).compareTo("W") != 0)
                  && (amver_sp_port_dep_lon.substring(7, 8).compareTo("E") != 0))) {
        JOptionPane.showMessageDialog(
            null,
            "port of departure longitude invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
        ...
        (main.amver_report.equals(main.AMVER_FR))) // K-line
    {
      ...
      if ((checks_ok) && (amver_sp_port_des_name.length() < 2)) {
        JOptionPane.showMessageDialog(
            null,
            "port of destination name not present",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok) && (amver_sp_port_des_lat.length() != 7)) {
        JOptionPane.showMessageDialog(
            null,
            "port of destination latitude invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok)
          && ((amver_sp_port_des_lat.substring(2, 3).compareTo("-") != 0)
              || (amver_sp_port_des_lat.substring(5, 6).compareTo(" ") != 0)
              || (amver_sp_port_des_lat.substring(6, 7).compareTo("N") != 0)
                  && (amver_sp_port_des_lat.substring(6, 7).compareTo("S") != 0))) {
        JOptionPane.showMessageDialog(
            null,
            "port of destination latutide invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok) && (amver_sp_port_des_lon.length() != 8)) {
        JOptionPane.showMessageDialog(
            null,
            "port of destination longitude invalid format",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      }
      ...
      if ((checks_ok)
          && ((amver_sp_port_des_lon.substring(3, 4).compareTo("-") != 0)
              || (amver_sp_port_des_lon.substring(6, 7).compareTo(" ") != 0)
              || (amver_sp_port_des_lon.substring(7, 8).compareTo("W") != 0)
                  && (amver_sp_port_des_lon.substring(7, 8).compareTo("E") != 0))) {
        JOptionPane.showMessageDialog(
            null,
            "port of destination longitude invalid format",
            main.APPLICATION_NAME + " error",
      ...
      if ((checks_ok) && (amver_sp_time_of_des_day.length() != 2)) {
        if (main.amver_report.equals(main.AMVER_FR)) {
          JOptionPane.showMessageDialog(
              null,
              "arrived day invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "ETA destination day invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
      ...
      if ((checks_ok) && (amver_sp_time_of_des_hour.length() != 2)) {
        if (main.amver_report.equals(main.AMVER_FR)) {
          JOptionPane.showMessageDialog(
              null,
              "arrived hour invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "ETA destination hour invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
      ...
      if ((checks_ok) && (amver_sp_time_of_des_minute.length() != 2)) {
        if (main.amver_report.equals(main.AMVER_FR)) {
          JOptionPane.showMessageDialog(
              null,
              "arrived minute invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "ETA destination minute invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
      ...
      if ((checks_ok) && (!month_3_letter_array.contains(amver_sp_time_of_des_month))) {
        if (main.amver_report.equals(main.AMVER_FR)) {
          JOptionPane.showMessageDialog(
              null,
              "arrived month invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        } else {
          JOptionPane.showMessageDialog(
              null,
              "ETA destination month invalid format",
              main.APPLICATION_NAME + " error",
              JOptionPane.WARNING_MESSAGE);
        }
        Reset_All_AMVER_SP_Vars();
    ...
    else // position report
    {
      ...
      if (number_destination_parts != 0 && number_destination_parts != 7) {
        JOptionPane.showMessageDialog(
            null,
            "For Position Report all 7 (optional) destination input fields must be empty or all 7 fields must be filled out",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_AMVER_SP_Vars();
      } // if (number_destination_parts != 0 && number_destination_parts != 7)
        ...
        for (int r = 0; r < AMVER_TRACK_ROWS; r++) {
          if (amver_track_data[r][1] != null) // column 1 is method
          {
            if ((amver_track_data[r][1].compareTo("RL") == 0)
              ...
              // so if e.g. row 0 is invalid (e.g. space) and rows 1,2,3 valid than
              // number_valid_routes = 3
              // see also next check

              // System.out.println(amver_track_data[r][1]);
            } else {
              //   JOptionPane.showMessageDialog(null, "r =" + r, main.APPLICATION_NAME + " error",
              // JOptionPane.WARNING_MESSAGE);
              //   JOptionPane.showMessageDialog(null, "amver track data =" +
              // amver_track_data[r][1], main.APPLICATION_NAME + " error",
              // JOptionPane.WARNING_MESSAGE);
              JOptionPane.showMessageDialog(
                  null,
                  "method route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
        ...
        for (int r = 0; r < number_valid_routes; r++) {
          ...
          if (r == number_valid_routes - 1) {
            if ((amver_track_data[r][2] != null) && (amver_track_data[r][2].compareTo("") != 0)
                ...
                || (amver_track_data[r][8] != null)
                    && (amver_track_data[r][8].compareTo("") != 0)) {
              JOptionPane.showMessageDialog(
                  null,
                  "the final route ("
                      + amver_track_data[r][0]
                      + ") requires only the navigation method (from the last turn point to the destination)",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
          ...
          else // so not the last route
          {
            ...
            else if ((amver_track_data[r][2] != null)
                && (amver_track_data[r][2].compareTo("") != 0)
                && (amver_track_data[r][2].length() != 4)) {
              JOptionPane.showMessageDialog(
                  null,
                  "speed route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
            ...
            else if ((amver_track_data[r][3] == null)
                || (amver_track_data[r][3].compareTo("") == 0)) {
              JOptionPane.showMessageDialog(
                  null,
                  "latitude route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
            ...
            // column 3: lat required [THIRD LAT CHECK]
                ...
                || (amver_track_data[r][3].substring(6, 7).compareTo("N") != 0)
                    && (amver_track_data[r][3].substring(6, 7).compareTo("S") != 0)) {
              JOptionPane.showMessageDialog(
                  null,
                  "latitude route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
            ...
            else if ((amver_track_data[r][4] == null)
                || (amver_track_data[r][4].compareTo("") == 0)) {
              JOptionPane.showMessageDialog(
                  null,
                  "longitude route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
            ...
            // column 4: lon required [THIRD LON CHECK]
                ...
                || (amver_track_data[r][4].substring(7, 8).compareTo("W") != 0)
                    && (amver_track_data[r][4].substring(7, 8).compareTo("E") != 0)) {
              JOptionPane.showMessageDialog(
                  null,
                  "longitude route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
            ...
            else if ((amver_track_data[r][5] == null)
                || (amver_track_data[r][5].compareTo("") == 0)) {
              JOptionPane.showMessageDialog(
                  null,
                  "ETA[day] route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
            ...
            else if ((amver_track_data[r][6] == null)
                || (amver_track_data[r][6].compareTo("") == 0)) {
              JOptionPane.showMessageDialog(
                  null,
                  "ETA[hh:mm] route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
            ...
            else if ((amver_track_data[r][7] != null)
                && (amver_track_data[r][7].compareTo("") != 0)
                && (amver_track_data[r][7].length() != 2)) {
              JOptionPane.showMessageDialog(
                  null,
                  "ETD[day] route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
            ...
            else if ((amver_track_data[r][8] != null)
                && (amver_track_data[r][8].compareTo("") != 0)
                && (amver_track_data[r][8].length() != 5)) {
              JOptionPane.showMessageDialog(
                  null,
                  "ETD[hh:mm] route " + amver_track_data[r][0] + " invalid format",
                  main.APPLICATION_NAME + " error",
                  JOptionPane.WARNING_MESSAGE);
              Reset_All_AMVER_SP_Vars();
              break;
    ...
    // Also, keep in mind that the mailto is considered the same as a URL of sorts and therefore
    // will have the same limitations for length.
    // See http://support.microsoft.com/kb/208427, note the maximum URL length of 2083 characters.
    // This is confirmed for mailto as well
    // in this article: http://support.microsoft.com/kb/279460/en-us. Also, some mail clients can
    // also have a limit (I believe older versions
    // of Outlook Express had a limit of something much smaller like 483 characters or something. If
    // you expect to have a longer string than that
    // then you'll need to look at alternatives.
    //
    // Microsoft Outlook limits you to 512 characters
    // (http://www.javapractices.com/topic/TopicAction.do?Id=242)
    if (checks_ok == true) {
      ...
      if (main.amver_report.equals(main.AMVER_SP)) {
        email_body =
            "AMVER/SP//"
                ...
                + "\n"
                +
                // "B/" + amver_sp_time_of_dep_day + amver_sp_time_of_dep_hour +
                // amver_sp_time_of_dep_minute + "Z" + "//" + "\n" +
                "B/"
                + amver_sp_time_of_dep_day
                + amver_sp_time_of_dep_hour
                + amver_sp_time_of_dep_minute
                ...
                + "\n"
                + "F/"
                + amver_sp_remainder_speed.replace(".", "")
                + "//"
                + "\n"
                + "G/"
                + amver_sp_port_dep_name
                + "/"
                + amver_sp_port_dep_lat.replace(" ", "").replace("-", "")
                + "/"
                + amver_sp_port_dep_lon.replace(" ", "").replace("-", "")
                + "//"
                + "\n"
                + "I/"
                + amver_sp_port_des_name
                + "/"
                + amver_sp_port_des_lat.replace(" ", "").replace("-", "")
                + "/"
                + amver_sp_port_des_lon.replace(" ", "").replace("-", "")
                + "/"
                +
                // amver_sp_time_of_des_day + amver_sp_time_of_des_hour +
                // amver_sp_time_of_des_minute + "Z" + "//" + "\n";
                amver_sp_time_of_des_day
                + amver_sp_time_of_des_hour
                + amver_sp_time_of_des_minute
                + "Z"
      ...
      if (main.amver_report.equals(main.AMVER_DR)) {
        email_body =
            "AMVER/DR//"
                ...
                + "\n"
                + "C/"
                + amver_dr_current_pos_lat.replace(" ", "").replace("-", "")
                + "/"
                + amver_dr_current_pos_lon.replace(" ", "").replace("-", "")
                + "//"
                + "\n"
                + "E/"
                + amver_sp_current_course
      ...
      if ((main.amver_report.equals(main.AMVER_SP)) || (main.amver_report.equals(main.AMVER_DR))) {
        for (int r = 0; r < number_valid_routes; r++) {
          ...
          // column 7: etd day          [only required if lay over, but not applicable for the last
          // route]
          // column 8: etd hr-min       [only required if lay over, but not applicable for the last
          // route]
    ...
    if (checks_ok == true) {
      ...
      // JOptionPane.showMessageDialog(null, email_body_lengte, main.APPLICATION_NAME + " email_body
      // lengte", JOptionPane.WARNING_MESSAGE);

      // always the email_body text to system clipboard (if user clicked the 'E-mail' button or
      // clicked the 'Clipboard' button)
      //
      ...
      if (invoke_email_program == false) // so user clicked the 'Clipboard button'
      {
        JOptionPane.showMessageDialog(
            null,
            "AMVER formatted message written to Clipboard",
    ...
    //
    /////////////// invoke default (on the user's computer) e-mail program (this section only if
  ...
  private void save_amver_sp() {
    ...
    // JFileChooser chooser = new JFileChooser();                                    // Constructs a
    // JFileChooser pointing to the user's default directory. This default depends on the operating
    // system. It is typically the "My Documents" folder on Windows, and the user's home directory
    // on Unix.
    ...
    {
      amver_dir =
          null; // NB Passing in a null string causes the file chooser to point to the user's
      // default directory (It is typically the "My Documents" folder on Windows)
    }
  ...
  private void read_sp_data_from_import_file(String import_record) {
    ...
    if (import_record.indexOf(AMVER_SP_VESSEL) != -1) {
      amver_sp_vessel =
          import_record.substring(
              SP_IMPORT_FILE_POS_INHOUD); // zo ja, dan staat op een bepaalde pos (achter de : ) de
      // inhoud
  ...
  private void initParameters() {
    ...
    if (main.amver_report.equals(main.AMVER_SP)) {
      ...
      for (int r = 0; r < AMVER_TRACK_ROWS; r++) {
        jTable1.setValueAt(
            Integer.toString(r + 1), r, 0); // array number start at 0 but route number at 1
      }
  ...
  private void insert_values_in_fields() {
    ...
    // rom version 4.2 call sign no longer required for meteo reports
  ...
  // private static final String SHIP_NAME_TXT           = "ship name          : ";   // t/m : is 20
  // characters
  ...
  public static String[][] amver_track_data =
      new String[AMVER_TRACK_ROWS][AMVER_TRACK_COLUMNS]; // NB default values: null
  ...
  public static final List<String> month_3_letter_array =
      Arrays.asList(
