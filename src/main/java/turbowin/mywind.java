...
//////////////////////////////////      
   ...
   {
      // AWS
      //if (!(main.wind_source.equals(main.MEASURED_OFF_BOW)) && (main.RS232_connection_mode == 3 || main.RS232_connection_mode == 9 || main.RS232_connection_mode == 10 || main.RS232_connection_mode == 11))
      //{
...
*/      
      ...
      //main.dashboard_form_APR_radar = new DASHBOARD_view_APR_radar();   // necessary otherwise nullpointer exceptions with update_APR_dashboard() etc.
   
      //main.Dashboard_APR_radar_actionperformed(null);
      
      if (main.dashboard_form_APR_radar != null) // otherwise the first time (if APR dashboard was never opened before) an exception)
      {
         // NB - this branch is activated if APR dashboard was opened before or is still open!
         //    - if APR Dashboard was never opened before then via initComponents1() [DASHBOARD_view_APR_radar.java]!
         //
         //
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   private void update_APR_dashboard()
   {
      ...
      // NB Due to the function check_wind_consistency_APR() [DASHBOARD_view_APR_radar.java] wind dir must be updaded before updating Bf class!
      if ( (main.wind_source.equals(main.ESTIMATED_TRUE)) || (main.wind_source.equals(main.MEASURED_TRUE)) )
      {
  ...
  //String hulp_wind_speed  = jTextField2.getText().trim();
         ...
         int int_hulp_wind_speed = (int) Math.round(Double.parseDouble(hulp_wind_speed));    // NB parseDouble and rounding: to prevent exceptions in case decimals were entered (e.g. 8.2)
