...
public class DASHBOARD_view_AWS extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    */ jPanel1 = new DASHBOARD_grafiek_AWS();
        ...
        jPanel3Layout
            ...
            .addGroup(
                ...
                jPanel3Layout
                    ...
                    .addGap(210, 210, 210)
                    .addComponent(
                        jButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                    .addGap(210, 210, 210)
                    .addComponent(
                        jLabel1,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    jLabel2.setText(
        "--- Pressure MSL = 1 min average at MSL. Pressure read, Temp, Humidity and SST = 1 min average at sensor height. Wind speed and dir = 10 min average at sensor height. Wind gust = max wind in last 10 min at sensor height ---");
        ...
        jPanel2Layout
            ...
            .addGroup(
                jPanel2Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1212, Short.MAX_VALUE)
                    .addContainerGap()));
  ...
  private void Dashboard_AWS_componentResizedHandler(
    ...
    System.out.println(
        "--- AWS Dashboard analog (jPanel1) size = " + DASHBOARD_view_AWS.jPanel1.getSize());
  ...
  private void init_dasboard_AWS_timer() {
    ...
    ActionListener update_dashboard_AWS_action =
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    dashboard_update_AWS_timer =
        new Timer(DELAY_UPDATE_AWS_SENSOR_LOOP, update_dashboard_AWS_action);
    dashboard_update_AWS_timer.setRepeats(true); // false = only one action
    dashboard_update_AWS_timer.setInitialDelay(
        INITIAL_DELAY_UPDATE_AWS_SENSOR_LOOP); // time in millisec to wait after timer is started to
    // fire first event
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(DASHBOARD_view_AWS.class.getName())
