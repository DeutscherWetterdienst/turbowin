 ...
 * @author  stam
 */
final public class myposition extends javax.swing.JFrame {
   ...
   private void initComponents2()
   {
      ...
      // AWS connected?
      if (main.RS232_connection_mode == 3 || main.RS232_connection_mode == 9 || main.RS232_connection_mode == 10 || main.RS232_connection_mode == 11)
      {
      ...
      if ( (main.obs_format.equals(main.FORMAT_101)) || (main.RS232_connection_mode == 3) || (main.RS232_connection_mode == 9) || (main.RS232_connection_mode == 10) || main.RS232_connection_mode == 11)
      {
      ...
      //if (main.RS232_connection_mode == 3 || main.RS232_connection_mode == 9 || main.RS232_connection_mode == 10 || main.RS232_connection_mode == 11) // AWS connected mode
      if (local_AWS_connected || (main.APR == true))    
      {
...
// TODO add your handling code here:
   ...
   private void OK_button_actionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OK_button_actionPerformed
      ...
      if ( (main.RS232_connection_mode != 3) && (main.RS232_connection_mode != 9) && (main.RS232_connection_mode != 10) && (main.RS232_connection_mode != 11))  // not AWS connected
      { 
      ...
      */
         ...
         new SwingWorker<Void, Void>()
         {
            ...
            protected Void doInBackground() throws Exception
            {
               ...
               if (os.equals("LINUX"))
               {
                  ...
                  {
                     String full_path_leaflet_maps_html_file = main.logs_dir + java.io.File.separator + main.LEAFLET_MAPS_HTML_FILE;
               ...
               else // Windows etc. 
               {
                  ...
                  if ( (Desktop.isDesktopSupported()) && ((main.logs_dir != null) && (main.logs_dir.compareTo("") != 0)) /*&& (main.offline_mode == false)*/ )
                  {
                     ...
                     //{ 
                     //   System.out.println("+++ unable to create dynamic html file for leaflet Maps plot [function: OK_button_actionPerformed()] (" + ex + ")");
                     //}
                     //catch (IOException ioe) 
                     //{ 
                     //   System.out.println("+++ unable to create dynamic html file for leaflet Maps plot [function: OK_button_actionPerformed()] (" + ioe + ")");
                     //}
      ...
      if (checks_ok == true)
      {
         ...
         //if (main.APR == false && main.RS232_connection_mode != 3 && main.RS232_connection_mode != 9 || main.RS232_connection_mode != 10)
         //{
         //   String info = "Ensure the bridge wing door is open before opening the pressure input page";
         //   JOptionPane.showMessageDialog(null, info,  main.APPLICATION_NAME + " advice", JOptionPane.INFORMATION_MESSAGE);
         //}
...
*/
   ...
   private void Position_In_leaflet_Maps(String full_path_leaflet_maps_html_file)
   {
      ...
      //
      String infowindow_lat = latitude_degrees + "&#176 " +  latitude_minutes + "' " + latitude_hemisphere.substring(0,1);
      String infowindow_lon = longitude_degrees + "&#176 " +  longitude_minutes + "' " + longitude_hemisphere.substring(0,1);
      
      // date time
      String infowindow_date_time = "";
      if (!main.leaflet_maps_obs_day.equals(""))  // NB if day is not blank also the other date/time parameters are not blank
      {
         infowindow_date_time = main.leaflet_maps_obs_day + " " + main.leaflet_maps_obs_month + " " + main.leaflet_maps_obs_year + "  " + main.leaflet_maps_obs_hour + ".00 UTC";
      }
     ...
     if (!main.leaflet_maps_obs_sst.equals(""))
      ...
      String infowindow_total = "\"" + "<h3>" + vessel + " weather observation" + "</h3>"
                              + "<p>"
                              + " position: " +  infowindow_lat + ", " +  infowindow_lon + "<br>"
                              + " date time: " + infowindow_date_time+ "<br>"
                              + infowindow_wind_dir  + "<br>"
      ...
      try (BufferedWriter out = new BufferedWriter(new FileWriter(full_path_leaflet_maps_html_file)))
      {
         ...
         out.newLine();
         out.write("<script>");out.newLine();
         out.write("  var map = L.map(\"map\").setView([" + leaflet_maps_lat + "," + leaflet_maps_lon + "], 3);");out.newLine();
         out.write("  L.esri.basemapLayer(\"Topographic\").addTo(map);");out.newLine();
         out.newLine();
         //out.write("  L.marker([" + leaflet_maps_lat + "," + leaflet_maps_lon + "]).addTo(map).bindPopup(\"<b>Hello world!</b><br />I am a popup.\").openPopup();");out.newLine();
         out.write("  L.marker([" + leaflet_maps_lat + "," + leaflet_maps_lon + "]).addTo(map).bindPopup(" + infowindow_total + ").openPopup();");out.newLine();
         out.newLine();
         out.write("</script>");out.newLine();
         out.newLine();
         out.write("</body>");out.newLine();
      ...
      {
         String info = "[GENERAL] unable to create dynamic html file for leaflet maps plot (" + ex + ")";
...
*/
   ...
   public static double SOG_APR_wind            = Double.MAX_VALUE; // used for "APR + FM13" (APR SOG is based on 3 hrs if FM13, so extra 10 min SOG for wind necessary)
   public static double COG_APR_wind            = Double.MAX_VALUE; // used for "APR + FM13" (APR COG is based on 3 hrs if FM13, so extra 10 min COG for wind necessary, also used if port mode option is set)
