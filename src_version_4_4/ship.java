...
public class ship 
{
   ...
   public ship(Color color_white, Color color_black, Color color_deck_passenger_ship, Color color_pool_1, Color color_pool_2, Color color_pool_3, Color color_acc_passenger_ship, Color color_life_boat, Color color_funnel_passenger_ship, 
               ...
               Color color_pipes_oil_tanker, Color color_deck_steel_blue, Color color_deck_reefer_ship, Color color_deck_general_cargo_classic, Color color_deck_research_vessel, Color color_crane_research_vessel, Color color_hoist_research_vessel, 
               ...
               Color color_tank_deck_fruit_juice_tanker, Color color_bridge_fruit_juice, Color color_tanks_fruit_juice, Color color_aft_deck_fruit_juice_tanker)
   {
   ...
   */
   ...
   /*                                                                                             */
   /***********************************************************************************************/
   public void draw_lng_tanker(Graphics2D g2d, double wind_rose_diameter, boolean night_mode, Color deck_color) 
   {
      //
      //  (x,y)  .
      //             /  \
