...
public final class mycloudcover extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jLabel13.setText(
        "This program computes a 'height of base of lowest cloud' advice if cloud classification, latitude, air temp, wet bulb temp and present weather are available");
        ...
        layout
            ...
            .addGroup(
                layout
                    ...
                    .addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED, 79, Short.MAX_VALUE)
                    .addComponent(
                        jSeparator1,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
  ...
  private void OK_button_actionPerformed(
    ...
    // total cloud cover
    if (jRadioButton1.isSelected() == true) N = N_CLOUDLESS;
    else if (jRadioButton2.isSelected() == true) N = N_1_8;
    else if (jRadioButton3.isSelected() == true) N = N_2_8;
    else if (jRadioButton4.isSelected() == true) N = N_3_8;
    else if (jRadioButton5.isSelected() == true) N = N_4_8;
    else if (jRadioButton6.isSelected() == true) N = N_5_8;
    else if (jRadioButton7.isSelected() == true) N = N_6_8;
    else if (jRadioButton8.isSelected() == true) N = N_7_8;
    else if (jRadioButton9.isSelected() == true) N = N_COMPLETELY_OVERCAST;
    else if (jRadioButton10.isSelected() == true) N = N_OBSCURED;
    else if (jRadioButton11.isSelected() == true) N = N_NOT_DETERMINED;
    else N = "";

    // amount of Cl (or Cm)
    if (jRadioButton12.isSelected() == true) Nh = NH_0_8;
    else if (jRadioButton13.isSelected() == true) Nh = NH_1_8;
    else if (jRadioButton14.isSelected() == true) Nh = NH_2_8;
    else if (jRadioButton15.isSelected() == true) Nh = NH_3_8;
    else if (jRadioButton16.isSelected() == true) Nh = NH_4_8;
    else if (jRadioButton17.isSelected() == true) Nh = NH_5_8;
    else if (jRadioButton18.isSelected() == true) Nh = NH_6_8;
    else if (jRadioButton19.isSelected() == true) Nh = NH_7_8;
    else if (jRadioButton20.isSelected() == true) Nh = NH_8_8;
    else if (jRadioButton21.isSelected() == true) Nh = NH_OBSCURED;
    else if (jRadioButton22.isSelected() == true) Nh = NH_NOT_DETERMINED;
    else Nh = "";

    // height lowest clouds in the sky
    if (jRadioButton23.isSelected() == true) h = H_CLOUDLESS;
    else if (jRadioButton24.isSelected() == true) h = H_0_50;
    else if (jRadioButton25.isSelected() == true) h = H_50_100;
    else if (jRadioButton26.isSelected() == true) h = H_100_200;
    else if (jRadioButton27.isSelected() == true) h = H_200_300;
    else if (jRadioButton28.isSelected() == true) h = H_300_600;
    else if (jRadioButton29.isSelected() == true) h = H_600_1000;
    else if (jRadioButton30.isSelected() == true) h = H_1000_1500;
    else if (jRadioButton31.isSelected() == true) h = H_1500_2000;
    else if (jRadioButton32.isSelected() == true) h = H_2000_2500;
    else if (jRadioButton33.isSelected() == true) h = H_GROTER_2500;
    else if (jRadioButton34.isSelected() == true) h = H_NOT_DETERMINED;
    else h = "";
    ...
    */
    ...
    // if ((num_N == 0) && (num_Nh != 0))
    if ((N.equals(N_CLOUDLESS) == true) && (Nh.compareTo(NH_0_8) != 0)) { // check 1200
      JOptionPane.showMessageDialog(
          null,
          "If 'total cloud cover' = 'cloudless' then 'amount of Cl' must be '0/8'",
    ...
    else if ((N.equals(N_CLOUDLESS) == true) && (h.compareTo(H_CLOUDLESS) != 0)) { // check 1200b
      // MessageBox("If 'total cloud cover' = 'cloudless' then 'height of base of lowest cloud in
      // the sky' must be 'cloudless'", "TurboWin error", MB_OK | MB_ICONWARNING);
      JOptionPane.showMessageDialog(
          null,
          "If 'total cloud cover' = 'cloudless' then 'height of base of lowest cloud' must be 'cloudless'",
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    }
    ...
    // else if ((num_N != 0) && (obs_h == h_0))
    else if ((N.compareTo(N_CLOUDLESS) != 0) && (h.equals(H_CLOUDLESS) == true)) { // check -
      // MessageBox("If 'height of base of lowest cloud in the sky' = 'cloudless' then 'total cloud
      // cover' must be 'cloudless'", "TurboWin error", MB_OK | MB_ICONWARNING);
      JOptionPane.showMessageDialog(
          null,
          "If 'height of base of lowest cloud' = 'cloudless' then 'total cloud cover' must be 'cloudless'",
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    }
    ...
    else if ((N.equals(N_OBSCURED) == true)
        && (h.compareTo(H_NOT_DETERMINED) != 0)
        && (h.compareTo("") != 0)) { // check 1205
      JOptionPane.showMessageDialog(
          null,
          "If 'total cloud cover' = 'obscured' then 'height of base of lowest cloud' must be 'not determined'",
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    }

    // else if ((obs_N == N_obscured) && (obs_Nh != Nh_obscured) && (obs_Nh != Nh_not_determined) &&
    // (obs_Nh != "\0"))
    else if ((N.equals(N_OBSCURED) == true)
        && (Nh.compareTo(NH_OBSCURED) != 0)
        && (Nh.compareTo(NH_NOT_DETERMINED) != 0)
        && (Nh.compareTo("") != 0)) { // check 1206
      JOptionPane.showMessageDialog(
          null,
          "If 'total cloud cover' = 'obscured' then 'amount of Cl (or Cm)' must be 'obscured' or 'not determined'",
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    }

    // else if ( ((obs_N == N_not_determined) || (obs_N == "\0")) && (obs_h != h_not_determined) &&
    // (obs_h != "\0") )
    else if (((N.equals(N_NOT_DETERMINED) == true) || (N.equals("") == true))
        && (h.compareTo(H_NOT_DETERMINED) != 0)
        && (h.compareTo("") != 0)) { // check 1210
      JOptionPane.showMessageDialog(
          null,
          "If 'total cloud cover' = 'not determined' then 'height of base of lowest cloud in the sky' must be 'not determined'",
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    }
    ...
    else if ((N.equals(N_NOT_DETERMINED) == true)
        && (Nh.compareTo(NH_NOT_DETERMINED) != 0)
        && (Nh.compareTo("") != 0)) { // check 1211
      JOptionPane.showMessageDialog(
          null,
          "If 'total cloud cover' = 'not determined' then 'amount of Cl (or Cm)' must be 'not determined'",
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    }

    // else if ( (num_N == 1 || num_N == 2 || num_N == 3 || num_N == 4 || num_N == 5 || num_N == 6
    // || num_N == 7 || num_N == 8) &&
    //          (num_Nh == 1 || num_Nh == 2 || num_Nh == 3 || num_Nh == 4 || num_Nh == 5 || num_Nh
    // == 6 || num_Nh == 7 || num_Nh == 8) &&
    //          (num_Nh > num_N) )
    else if (((N.equals(N_1_8) == true)
            || (N.equals(N_2_8) == true)
            || (N.equals(N_3_8) == true)
            || (N.equals(N_4_8) == true)
            || (N.equals(N_5_8) == true)
            || (N.equals(N_6_8) == true)
            || (N.equals(N_7_8) == true)
            || (N.equals(N_COMPLETELY_OVERCAST) == true))
        && ((Nh.equals(NH_1_8) == true)
            || (Nh.equals(NH_2_8) == true)
            || (Nh.equals(NH_3_8) == true)
            || (Nh.equals(NH_4_8) == true)
            || (Nh.equals(NH_5_8) == true)
            || (Nh.equals(NH_6_8) == true)
            || (Nh.equals(NH_7_8) == true)
            || (Nh.equals(NH_8_8) == true))
        && (Integer.parseInt(Nh.substring(0, 1))
            > Integer.parseInt(N.substring(0, 1)))) // truck to compare num values
    { // check -
      // MessageBox("'total cloud cover' must be >= 'amount of Cl (or Cm if Cl is not present)'",
      // "TurboWin error", MB_OK | MB_ICONWARNING);
      JOptionPane.showMessageDialog(
          null,
          "'total cloud cover' must be >= 'amount of Cl (or Cm)'",
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    } else if ((Nh.equals(NH_0_8))
        && !(h.equals(H_CLOUDLESS))
        && !(h.equals(H_GROTER_2500))
        && !(h.equals(H_NOT_DETERMINED))
        && !(h.equals(""))) {
      // JOptionPane.showMessageDialog(null, "If 'amount of Cl (or Cm if Cl not present)' = 0/8 then
      // 'height of base of lowest cloud' must be 'cloudless' or '>= 2500 m' or 'not determined'",
      // main.APPLICATION_NAME + " error", JOptionPane.WARNING_MESSAGE);
      JOptionPane.showMessageDialog(
          null,
          "If 'amount of Cl (or Cm if Cl not present)' = 0/8 then 'height of base of lowest cloud' cannot be "
              + h,
          main.APPLICATION_NAME + " error",
          JOptionPane.WARNING_MESSAGE);
      Reset_All_Cloudcover_Vars();
    ...
    if (checks_ok == true) {
      ...
      //
      if (N.equals(N_CLOUDLESS)) N_code = "0";
      else if (N.equals(N_1_8)) N_code = "1";
      else if (N.equals(N_2_8)) N_code = "2";
      else if (N.equals(N_3_8)) N_code = "3";
      else if (N.equals(N_4_8)) N_code = "4";
      else if (N.equals(N_5_8)) N_code = "5";
      else if (N.equals(N_6_8)) N_code = "6";
      else if (N.equals(N_7_8)) N_code = "7";
      else if (N.equals(N_COMPLETELY_OVERCAST)) N_code = "8";
      else if (N.equals(N_OBSCURED)) N_code = "9";
      else if (N.equals(N_NOT_DETERMINED)) N_code = "/";
      else N_code = "/";

      // determine code figure Nh
      //
      if (Nh.equals(NH_0_8)) Nh_code = "0";
      else if (Nh.equals(NH_1_8)) Nh_code = "1";
      else if (Nh.equals(NH_2_8)) Nh_code = "2";
      else if (Nh.equals(NH_3_8)) Nh_code = "3";
      else if (Nh.equals(NH_4_8)) Nh_code = "4";
      else if (Nh.equals(NH_5_8)) Nh_code = "5";
      else if (Nh.equals(NH_6_8)) Nh_code = "6";
      else if (Nh.equals(NH_7_8)) Nh_code = "7";
      else if (Nh.equals(NH_8_8)) Nh_code = "8";
      else if (Nh.equals(NH_OBSCURED)) Nh_code = "9";
      else if (Nh.equals(NH_NOT_DETERMINED)) Nh_code = "/";
      else Nh_code = "/";

      // determine code figure h
      //
      if (h.equals(H_CLOUDLESS)) h_code = "9";
      else if (h.equals(H_0_50)) h_code = "0";
      else if (h.equals(H_50_100)) h_code = "1";
      else if (h.equals(H_100_200)) h_code = "2";
      else if (h.equals(H_200_300)) h_code = "3";
      else if (h.equals(H_300_600)) h_code = "4";
      else if (h.equals(H_600_1000)) h_code = "5";
      else if (h.equals(H_1000_1500)) h_code = "6";
      else if (h.equals(H_1500_2000)) h_code = "7";
      else if (h.equals(H_2000_2500)) h_code = "8";
      else if (h.equals(H_GROTER_2500)) h_code = "9";
      else h_code = "/";
  ...
  private void Internet_button_actionPerformed(
    ...
    // TODO add your handling code here:
    main.help_mouseClicked(CLOUDCOVER_HELP_DIR);
  ...
  private void initSynopparameters() {
    ...
    // total cloud cover (N)
    if (N.compareTo("") != 0) {
      if (N.equals(N_CLOUDLESS)) jRadioButton1.setSelected(true);
      else if (N.equals(N_1_8)) jRadioButton2.setSelected(true);
      else if (N.equals(N_2_8)) jRadioButton3.setSelected(true);
      else if (N.equals(N_3_8)) jRadioButton4.setSelected(true);
      else if (N.equals(N_4_8)) jRadioButton5.setSelected(true);
      else if (N.equals(N_5_8)) jRadioButton6.setSelected(true);
      else if (N.equals(N_6_8)) jRadioButton7.setSelected(true);
      else if (N.equals(N_7_8)) jRadioButton8.setSelected(true);
      else if (N.equals(N_COMPLETELY_OVERCAST)) jRadioButton9.setSelected(true);
      else if (N.equals(N_OBSCURED)) jRadioButton10.setSelected(true);
      else if (N.equals(N_NOT_DETERMINED)) jRadioButton11.setSelected(true);
    ...
    // amount of Cl/Cm (Nh)
    if (Nh.compareTo("") != 0) {
      if (Nh.equals(NH_0_8)) jRadioButton12.setSelected(true);
      else if (Nh.equals(NH_1_8)) jRadioButton13.setSelected(true);
      else if (Nh.equals(NH_2_8)) jRadioButton14.setSelected(true);
      else if (Nh.equals(NH_3_8)) jRadioButton15.setSelected(true);
      else if (Nh.equals(NH_4_8)) jRadioButton16.setSelected(true);
      else if (Nh.equals(NH_5_8)) jRadioButton17.setSelected(true);
      else if (Nh.equals(NH_6_8)) jRadioButton18.setSelected(true);
      else if (Nh.equals(NH_7_8)) jRadioButton19.setSelected(true);
      else if (Nh.equals(NH_8_8)) jRadioButton20.setSelected(true);
      else if (Nh.equals(NH_OBSCURED)) jRadioButton21.setSelected(true);
      else if (Nh.equals(NH_NOT_DETERMINED)) jRadioButton22.setSelected(true);
      else jRadioButton22.setSelected(true); // not determined
    } // if (N.compareTo("") != 0)
    else jRadioButton22.setSelected(true); // not determined
    ...
    else if (h_advies == 0) jRadioButton24.setSelected(true);
    else if (h_advies == 1) jRadioButton25.setSelected(true);
    else if (h_advies == 2) jRadioButton26.setSelected(true);
    else if (h_advies == 3) jRadioButton27.setSelected(true);
    else if (h_advies == 4) jRadioButton28.setSelected(true);
    else if (h_advies == 5) jRadioButton29.setSelected(true);
    else if (h_advies == 6) jRadioButton30.setSelected(true);
    else if (h_advies == 7) jRadioButton31.setSelected(true);
    else if (h_advies == 8) jRadioButton32.setSelected(true);
    else if (h_advies == 9) jRadioButton33.setSelected(true);
    else jRadioButton34.setSelected(true); // not determined
  }
  ...
  private int Compute_h_advice() {
    ...
    switch (local_int_Cl) {
      case 1:
      case 2:
        if (local_double_air_temp != main.INVALID && local_double_dew_point != main.INVALID) {
          double hoogte = (local_double_air_temp - local_double_dew_point) * 125;

          if (hoogte < 50.0) h_advies = 0; // 0 - 50 meter
          else if (hoogte >= 50.0 && hoogte < 100.0) h_advies = 1;
          else if (hoogte >= 100.0 && hoogte < 200.0) h_advies = 2;
          else if (hoogte >= 200.0 && hoogte < 300.0) h_advies = 3;
          else if (hoogte >= 300.0 && hoogte < 600.0) h_advies = 4;
          else if (hoogte >= 600.0 && hoogte < 1000.0) h_advies = 5;
          else if (hoogte >= 1000.0 && hoogte < 1500.0) h_advies = 6;
          else if (hoogte >= 1500.0 && hoogte < 2000.0) h_advies = 7;
          else if (hoogte >= 2000.0 && hoogte < 2500.0) h_advies = 8;
      ...
      case 4:
      case 5:
        if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 4;
        else if (local_int_latitude_degrees > 20 && local_int_latitude_degrees < 70) h_advies = 5;
        else if (local_int_latitude_degrees <= 20 && local_int_latitude_degrees >= 0) h_advies = 6;
        break;
      case 6:
      case 7:
        if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 1;
        else if (local_int_latitude_degrees > 20 && local_int_latitude_degrees < 70) h_advies = 2;
        else if (local_int_latitude_degrees <= 20 && local_int_latitude_degrees >= 0) h_advies = 3;
        break;
      case 8:
        if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 4;
        else if (local_int_latitude_degrees > 20 && local_int_latitude_degrees < 70) h_advies = 5;
        else if (local_int_latitude_degrees <= 20 && local_int_latitude_degrees >= 0) h_advies = 5;
        break;
      case 9:
        if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 4;
        else if (local_int_latitude_degrees > 20 && local_int_latitude_degrees < 70) h_advies = 5;
    ...
    if (local_int_Cl == 0) {
      switch (local_int_Cm) {
        case 1:
          if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 8;
          else if (local_int_latitude_degrees > 20 && local_int_latitude_degrees < 70) h_advies = 9;
          else if (local_int_latitude_degrees <= 20 && local_int_latitude_degrees >= 0)
            h_advies = 9;
          break;
        case 2: // (continious) neerslag (rain, snow , ice pellets (zie bij main differences
          // Nimbostratus and similar clouds of other genera) /
          if (local_int_ww_code == 61
              || local_int_ww_code == 63
              || local_int_ww_code == 65
              || local_int_ww_code == 66
              || local_int_ww_code == 67
              || local_int_ww_code == 68
              || local_int_ww_code == 69
              || local_int_ww_code == 71
              || local_int_ww_code == 73
              || local_int_ww_code == 75
              || local_int_ww_code == 79) {
            if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 2;
          ...
          {
            if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 6;
            else if (local_int_latitude_degrees > 20 && local_int_latitude_degrees < 70)
              h_advies = 7;
            else if (local_int_latitude_degrees <= 20 && local_int_latitude_degrees >= 0)
              h_advies = 8;
        ...
        case 7:
          if (local_int_latitude_degrees >= 70 && local_int_latitude_degrees <= 90) h_advies = 6;
          else if (local_int_latitude_degrees > 20 && local_int_latitude_degrees < 70) h_advies = 7;
          else if (local_int_latitude_degrees <= 20 && local_int_latitude_degrees >= 0)
            h_advies = 8;
          break;
        case 8:
  ...
  // private constants
  private final String CLOUDCOVER_HELP_DIR = "cloud_cover_height.pdf";
