...
public final class mybarograph extends javax.swing.JFrame {
        ...
        jPanel1Layout
            ...
            .addGroup(
                jPanel1Layout
                    ...
                    .addComponent(
                        jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
                    .addContainerGap()));
  ...
  private void initImages() {
    ...
    if (os.equals("LINUX")) {
      ...
      loadImage_straight(
          main.ICONS_DIRECTORY
              + "A_0.jpg"); // nummers alleen omdat een string comment door loadimage en verder
      // aangegeven is, heeft hier verder geen nut
      loadImage_straight(main.ICONS_DIRECTORY + "A_0_same.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_1.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_2.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_3.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_4.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_5.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_5_same.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_6.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_7.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "A_8.jpg");
    } else {
      loadImage(
          main.ICONS_DIRECTORY
              + "A_0.jpg"); // nummers alleen omdat een string comment door loadimage en verder
  ...
  private void loadImage_straight(final String imagePath) {
    ...
    //
    if (imagePath.equals(main.ICONS_DIRECTORY + "A_0.jpg")) {
      ImageIcon img_a_0 = createImageIcon(imagePath);
      jLabel1.setIcon(img_a_0);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_1.jpg")) {
      ImageIcon img_a_1 = createImageIcon(imagePath);
      jLabel2.setIcon(img_a_1);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_2.jpg")) {
      ImageIcon img_a_2 = createImageIcon(imagePath);
      jLabel3.setIcon(img_a_2);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_3.jpg")) {
      ImageIcon img_a_3 = createImageIcon(imagePath);
      jLabel4.setIcon(img_a_3);
    }
    ...
    //
      ...
      ImageIcon img_a_5 = createImageIcon(imagePath);
      jLabel5.setIcon(img_a_5);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_6.jpg")) {
      ImageIcon img_a_6 = createImageIcon(imagePath);
      jLabel6.setIcon(img_a_6);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_7.jpg")) {
      ImageIcon img_a_7 = createImageIcon(imagePath);
      jLabel7.setIcon(img_a_7);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_8.jpg")) {
      ImageIcon img_a_8 = createImageIcon(imagePath);
      jLabel8.setIcon(img_a_8);
    }
    ...
    //
      ...
      ImageIcon img_a_0_same = createImageIcon(imagePath);
      jLabel9.setIcon(img_a_0_same);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_4.jpg")) {
      ImageIcon img_a_4 = createImageIcon(imagePath);
      jLabel10.setIcon(img_a_4);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "A_5_same.jpg")) {
      ImageIcon img_a_5_same = createImageIcon(imagePath);
      jLabel11.setIcon(img_a_5_same);
    }
  } // private void loadImage(final String imagePath, final int index)
  ...
  private void initSynopparameters() {
    ...
    {
      RS232_mintaka
          .RS232_Mintaka_Duo_Read_Sensor_Data_a_ppp_Data_Files_For_Obs(); // this function will set
      // 'pressure_amount_tendency' and 'a_code'
    } else if (main.RS232_connection_mode == 5
        || main.RS232_connection_mode == 6) // Mintaka Star USB or Mintaka Sar WiFi connected
    {
      boolean StarX = false;
      RS232_mintaka.RS232_Mintaka_Star_And_StarX_Read_Sensor_Data_a_ppp_Data_Files_For_Obs(
          StarX); // this function will set 'pressure_amount_tendency' and 'a_code'
    } else if (main.RS232_connection_mode == 7
        || main.RS232_connection_mode == 8) // Mintaka StarX USB or Mintaka StarX WiFi connected
    {
      boolean StarX = true;
      RS232_mintaka.RS232_Mintaka_Star_And_StarX_Read_Sensor_Data_a_ppp_Data_Files_For_Obs(
          StarX); // this function will set 'pressure_amount_tendency' and 'a_code'
    ...
    {
      RS232_vaisala.RS232_Read_Sensor_Data_a_ppp_For_Obs(); // this function will set
      // 'pressure_amount_tendency' and 'a_code'
    }
    ...
    // characteristic of pressure tendency (if no barometer connected, because then RS232
    // applicable))
    //
    if ((a_code.compareTo("") != 0) && (local_barometer_connected == false)) {
      // pressure the same as 3hrs ago?
      //
      // NB neccessary in the case of a = 0 or a = 5 (they could be lower/ higher or the same; see
      // graphs a =  0 has 2 selection options and a = 5 has 2 selection options)
      //
      ...
      if (a_code.equals(A_0)
          || a_code.equals(
              A_0_SAME)) // NB A_0 and A_0_SAME have the same value (0); so you need boolean
      // hulp_pressure_tendency_0_0
      {
      ...
      // pressure lower than 3hrs ago (or the same in case of a = 5)
          ...
          || a_code.equals(
              A_5_SAME)) // NB A_5 and A_5_SAME have the same value (5); so you need boolean
      // hulp_pressure_tendency_0_0
      {
        if (hulp_pressure_tendency_0_0) {
    ...
    if (local_AWS_connected == false) // not AWS
    {
      ...
      */
      if (checks_ok == true) {
        ...
        if ((pressure_amount_tendency.trim().length() > 0)
          ...
          JOptionPane.showMessageDialog(
              null,
              "amount of pressure tendency must be in range 0.0 - 50.0 or blank",
      ...
      */
      if (a_code.equals(A_4) && double_pressure_amount_tendency != 0) {
        JOptionPane.showMessageDialog(
            null,
            "if characteristic of pressure tendency = 'steady' (a = 4) then amount of pressure tendency must be 0.0",
            main.APPLICATION_NAME + " error",
            JOptionPane.WARNING_MESSAGE);
        Reset_All_Barograph_Vars(); // hier wordt ook "checks_ok" op false gezet
      }
  ...
  public static final String A_0 = "0"; // "rising, then falling (a = 0)";
  public static final String A_0_SAME = "0"; // "rising, then falling (a = 0)";
  public static final String A_1 =
      "1"; // "rising, then steady; or rising, then rising more slowly (a = 1)";
  public static final String A_2 = "2"; // "rising (steadily or unsteadily) (a = 2)";
  public static final String A_3 =
      "3"; // "falling, then rising; or steady, then rising; or rising, then rising more quickly  (a
  // = 3)";
  public static final String A_4 = "4"; // "steady (a = 4)";
  public static final String A_5 = "5"; // "falling, then rising (a = 5)";
  public static final String A_5_SAME = "5"; // "falling, then rising (a = 5)";
  public static final String A_6 =
      "6"; // "falling, then steady; or falling, then falling more slowly (a = 6)";
  public static final String A_7 = "7"; // "falling (steadily or unsteadily)  (a = 7)";
  public static final String A_8 =
      "8"; // "rising, then falling; or steady, then falling; or falling, then falling more quickly
  // (a = 8) ";
  public static final String BAROGRAAF_HELP_DIR = "barograph.pdf";
