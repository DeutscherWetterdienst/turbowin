 ...
 * @author  Martin
 */
final public class mybarometer extends javax.swing.JFrame {
   ...
   private void initComponents() {
      ...
      jLabel6.setText("** meta data (Maintenance --> Station data), this is NOT the height correction");
   ...
   private void initComponents2()
   {
      ...
      if (local_AWS_connected || (main.APR == true))              // AWS connected mode or APR mode   
      {
         ...
         jLabel10.setText("");      // overwrite the default text "Ensure the bridge wing door is opened to equalize the pressure before reading"
      }
      else
      {
      ...
      {
         jLabel10.setText("--- Ensure the bridge wing door is opened to equalize the pressure before reading ---");
      }
      else if ((main.APR == false) && (main.RS232_connection_mode == 1 || main.RS232_connection_mode == 2 || main.RS232_connection_mode == 4 || main.RS232_connection_mode == 5 || main.RS232_connection_mode == 6 ))
      {
         jLabel10.setText("--- Ensure the bridge wing door was opened to equalize the pressure before this page was opened ---");
      }
   }
   ...
   private void initSynopparameters() 
   {
       ...
       // AWS
       //
       if ((local_AWS_connected) && (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_YES))) 
       {
          // AWS connected
       ...
       //
       if ( (local_barometer_connected) && (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_YES))) 
       {
       ...
       else if ( (main.RS232_connection_mode == 1 || main.RS232_connection_mode == 2) && (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_NO)) )
       {
          ...
          RS232_vaisala.RS232_Read_Sensor_Data_PPPP_For_Obs(local_tray_icon_clicked);                // this function will set 'pressure_reading' in jTextfield1
       ...
       else if ( (main.RS232_connection_mode == 4) && (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_NO)) )                                                       
       {
          ...
          boolean local_tray_icon_clicked = false;
          RS232_mintaka.RS232_Mintaka_Duo_Read_Sensor_Data_PPPP_For_Obs(local_tray_icon_clicked);    // this function will set 'pressure_reading'
       } 
       else if ( (main.RS232_connection_mode == 5) && (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_NO)) )                                                       
       {
          ...
          boolean local_tray_icon_clicked = false;
          boolean StarX = false;
          RS232_mintaka.RS232_Mintaka_Star_And_StarX_Read_Sensor_Data_PPPP_For_Obs(local_tray_icon_clicked, StarX);    // this function will set 'pressure_reading'
       }       
       ...
       else if ( (main.RS232_connection_mode == 7) && (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_NO)) )                                                       
       {
       ...
       else if ( (main.RS232_connection_mode == 8) && (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_NO)) )                                                       
       {
       ...
       // pressure_reading, only if no barometer connected (because if barometer connected the then RS232 applicable see above eg main_RS232_RS422.RS232_Read_Sensor_Data_PPPP_For_Obs(local_tray_icon_clicked))
    ...
    private void OK_button_actionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OK_button_actionPerformed
       ...
       */
       ...
       {
          {
             JOptionPane.showMessageDialog(null, "instrument correction not available (Maintenance -> Station data)", main.APPLICATION_NAME + " error", JOptionPane.WARNING_MESSAGE);
             Reset_All_Barometer_Vars();                   // "checks_ok" -> false
          } // if ( (main.pressure_reading_msl_yes_no.compareTo(main.PRESSURE_READING_MSL_NO) != 0) etc.
       }
       ...
       */
       if (checks_ok == true)
       {
          ...
          {
             JOptionPane.showMessageDialog(null, "instrument correction must be in range -4.0 - 4.0 (Maintenance -> Station data)", main.APPLICATION_NAME + " error", JOptionPane.WARNING_MESSAGE);
             Reset_All_Barometer_Vars();                   // hier wordt ook "checks_ok" op false gezet
          }
