...
public void paintComponent(Graphics g)
{
 ...
 ////////////////////////////////////////////////// END TESTING ////////////////////////////////////////
   ...
   if (main.ship_deck_color_String.equals("") == false)
   {
      try
      {
         DASHBOARD_view_AWS_hybrid.deck_color = new Color(Integer.parseInt(main.ship_deck_color_String), true);   // String to Color
      }
   ...
   if (main.ship_tank_color_String.equals("") == false)
   {
      try
      {
         DASHBOARD_view_AWS_hybrid.tank_color = new Color(Integer.parseInt(main.ship_tank_color_String), true);   // String to Color
      }
      catch (NumberFormatException e)
      {
   ...
   if (course_ok)
   {
      ...
      {
         // NB "DASHBOARD_view_AWS_hybrid.deck_color = null" by default en will always stay at null; in AWS hybrid mode no menu option to select different deck colors (contray to AWS-radar and APR-radar dashboards)
         // NB TRICK: contrary to the line up here, via the AWS wind radar dashboard sub menu the colors can be changed, these changed colors will then also be visible in the bybrid dashboard!  
         //
         case main.YACHT                 : main.myship.draw_yacht(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
         case main.FULL_RIGGED_3         : main.myship.draw_tall_ship(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
         case main.FULL_RIGGED_4         : main.myship.draw_tall_ship(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
         case main.FULL_RIGGED_5         : main.myship.draw_tall_ship(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
         case main.BARQUE_3              : main.myship.draw_tall_ship(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
         case main.BARQUE_4              : main.myship.draw_tall_ship(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
         ...
         case main.REEFER_SHIP           : main.myship.draw_reefer_ship(g2d, wind_rose_diameter, DASHBOARD_view_AWS_hybrid.night_vision); break;
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_temp_text = -(block_temp_height / 2.0) + (4 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_temp_text = -(block_temp_height / 2.0) + (5 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font 
   {
      y_temp_data = -(block_temp_height / 2.0) + (5 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_temp_data = -(block_temp_height / 2.0) + (6 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_humidity_text = -(block_temp_height / 2.0) + (7 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_humidity_text = -(block_temp_height / 2.0) + (9 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_relative_wind_text = -(block_temp_height / 2.0) + (10 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_relative_wind_text = -(block_temp_height / 2.0) + (13 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1")) 
   {
      g2d.drawString("Relative wind dir", (int)x_relative_wind_dir_text, (int)y_relative_wind_text);
   }
   else
   {
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_relative_wind_data = -(block_temp_height / 2.0) + (11 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_relative_wind_data = -(block_temp_height / 2.0) + (14 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_true_wind_text = -(block_temp_height / 2.0) + (13 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_true_wind_text = -(block_temp_height / 2.0) + (17 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_true_wind_data = -(block_temp_height / 2.0) + (14 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_true_wind_data = -(block_temp_height / 2.0) + (18 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_true_gust_text = -(block_temp_height / 2.0) + (16 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_true_gust_text = -(block_temp_height / 2.0) + (21 * height_measured_at);      // bottom of the text string itself
   }
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      y_true_gust_data = -(block_temp_height / 2.0) + (17 * height_measured_at);      // bottom of the text string itself
   }
   else
   {
      y_true_gust_data = -(block_temp_height / 2.0) + (22 * height_measured_at);      // bottom of the text string itself
   }
   ...
   {
      if (main.AWSR)                                                      // e.g. OMC-140 and 'EUCAWS + uploads via TurboWin+' (but NOT 'EUCAWS + uploads via own iridium modem' or APR)
      {
         ...
         if ( ((AWSR_system_hour + 1) % Integer.valueOf(main.AWSR_reporting_interval)) == 0)    
         {
            ...
            {
               DASHBOARD_view_AWS_hybrid.jButton1.setEnabled(false);
               visual_obs_message = "Visual observation possible in " + (AWSR_minutes_for_upload -30) + " minutes";
            }   
         }
         else
         {
...
*/      
   ...
   if (main.dashboard_font.equals("1"))                   // bigger font
   {
      ...
      g2d.drawString("True wind", (int)(-wind_rose_diameter / 2), (int)(wind_rose_diameter / 2) + height_font);
   }
   else
   {
      g2d.drawString("True wind", (int)(-wind_rose_diameter / 2), (int)(wind_rose_diameter / 2));
