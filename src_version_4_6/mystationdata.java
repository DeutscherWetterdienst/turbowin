 ...
 * @author  Martin
 */
final public class mystationdata extends javax.swing.JFrame {
   ...
   private void initComponents() {
            ...
            .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               ...
               .addGroup(jPanel6Layout.createSequentialGroup()
                  ...
                  .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                     ...
                     .addComponent(jRadioButton16, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                     .addComponent(jRadioButton15, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                     .addComponent(jRadioButton14, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)))
               .addGroup(jPanel6Layout.createSequentialGroup()
                  .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      ...
      jLabel9.setText("*** only if AWS with wind sensor is connected     **** negative if SLL below WL");

      jLabel4.setText("** average over the whole calibration range, this is NOT the height correction (always 0.0 if AWS connected)");
      ...
      layout.setHorizontalGroup(
                     ...
                     .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                           ...
                           .addGroup(layout.createSequentialGroup()
                              .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                 .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel17, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 401, javax.swing.GroupLayout.PREFERRED_SIZE)
         ...
         .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               ...
               .addComponent(jLabel22, javax.swing.GroupLayout.PREFERRED_SIZE, 425, javax.swing.GroupLayout.PREFERRED_SIZE)
   ...
   private void lees_iso_landen_codes()
   {
      ...
      new SwingWorker<Void, Void>()
      {
         ...
         protected Void doInBackground() throws Exception
         {
            ...
            try (InputStream is = getClass().getResourceAsStream(main.ICONS_DIRECTORY + "ISO_landen_codes.txt");
...
/***********************************************************************************************/    
    private void OK_button_actionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OK_button_actionPerformed
      ...
      //           (main.RS232_connection_mode == 3 || main.RS232_connection_mode == 9 || main.RS232_connection_mode == 10 || main.RS232_connection_mode == 11) )            // AWS connected
      // {
      ...
      // else if ((main.wind_source.equals(main.MEASURED_OFF_BOW) == false) && ((main.RS232_connection_mode == 3) || (main.RS232_connection_mode == 9) || (main.RS232_connection_mode == 10) || (main.RS232_connection_mode == 11))) 
      // {
      ...
      // }
       ...
       //        (main.RS232_connection_mode == 3 || main.RS232_connection_mode == 9 || main.RS232_connection_mode == 10 || main.RS232_connection_mode == 11) )            // AWS connected
       //{
       //   info = "If AWS connected please insert also the \"average height of the anemometer above WL\"\n";
       //} 
       ...
       if (doorgaan == true)
       {
          ...
          try
          {
            double double_barometer_instrument_correction = Double.parseDouble(main.barometer_instrument_correction.trim());
             ...
             //if ( (main.barometer_instrument_correction.trim().length() > 0) && (double_barometer_instrument_correction < -4.0 || double_barometer_instrument_correction > 4.0) )
             if ( double_barometer_instrument_correction < -4.0 || double_barometer_instrument_correction > 4.0 )
             {
                JOptionPane.showMessageDialog(null, "barometer instrument correction must be in range -4.0 - 4.0", main.APPLICATION_NAME + " error", JOptionPane.WARNING_MESSAGE);
                doorgaan = false;     
             }
          }
          catch (NumberFormatException e) 
