...
public final class myserversettings extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jRadioButton1.setText("HTTPS protocol");

    buttonGroup1.add(jRadioButton2);
    jRadioButton2.setText("HTTP protocol");
    ...
    jLabel1.setText("upload URL*; for 'Output -> Obs to server' and AP[&T]R / AWSR");
  ...
  private void initComponents2() {
    ...
    // protocol (HTTPS or HTTP) client -> server
    //          most HTTPS URLs can communicate with HTTPS and HTTP protocol
    //          altough HTTPS is recommended (secure) alternative is HTTP (if performance is
    // critical)
    if (main.server_com_protocol.equals(main.HTTPS_PROTOCOL)) {
      jRadioButton1.setSelected(true); // HTTPS protocol
      jRadioButton2.setSelected(false); // HTTP protocol
    } else if (main.server_com_protocol.equals(main.HTTP_PROTOCOL)) {
      jRadioButton1.setSelected(false);
      jRadioButton2.setSelected(true);
    } else {
      // so if nothing was selected before -> HTTPS protocol will be set as default
  ...
  private void OK_button_actionPerformed(
    ...
    // HTTPS-HTTP protocol
    if (jRadioButton1.isSelected() == true) // use HTTPS protocol for communication client -> server
    {
      main.server_com_protocol = main.HTTPS_PROTOCOL;
    } else if (jRadioButton2.isSelected()
        == true) // uuse HTTP protocol for communication client -> server
    {
      main.server_com_protocol = main.HTTP_PROTOCOL;
    }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(myserversettings.class.getName())
