...
public final class mych extends javax.swing.JFrame {
  ...
  private void initImages() {
    ...
    if (os.equals("LINUX")) {
      ...
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_1.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_2.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_3.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_4.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_5.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_6.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_7.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_8.jpg");
      loadImage_straight(main.ICONS_DIRECTORY + "glyph_ch_9.jpg");
    } else {
  ...
  private void loadImage_straight(final String imagePath) {
    if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_1.jpg")) {
      ...
      ImageIcon img_ch2 = createImageIcon(imagePath);
      jLabel2.setIcon(img_ch2);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_3.jpg")) {
      ImageIcon img_ch3 = createImageIcon(imagePath);
      jLabel3.setIcon(img_ch3);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_4.jpg")) {
      ImageIcon img_ch4 = createImageIcon(imagePath);
      jLabel4.setIcon(img_ch4);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_5.jpg")) {
      ImageIcon img_ch5 = createImageIcon(imagePath);
      jLabel5.setIcon(img_ch5);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_6.jpg")) {
      ImageIcon img_ch6 = createImageIcon(imagePath);
      jLabel6.setIcon(img_ch6);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_7.jpg")) {
      ImageIcon img_ch7 = createImageIcon(imagePath);
      jLabel7.setIcon(img_ch7);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_8.jpg")) {
      ImageIcon img_ch8 = createImageIcon(imagePath);
      jLabel8.setIcon(img_ch8);
    } else if (imagePath.equals(main.ICONS_DIRECTORY + "glyph_ch_9.jpg")) {
      ImageIcon img_ch9 = createImageIcon(imagePath);
      jLabel9.setIcon(img_ch9);
    }
  } // private void loadImage(final String imagePath, final int index)
  ...
  private void initSynopparameters() {
    ...
    if (ch_code.compareTo("") != 0) {
      if (ch_code.equals(CH1)) jRadioButton1.setSelected(true);
      else if (ch_code.equals(CH2)) jRadioButton2.setSelected(true);
      else if (ch_code.equals(CH3)) jRadioButton3.setSelected(true);
      else if (ch_code.equals(CH4)) jRadioButton4.setSelected(true);
      else if (ch_code.equals(CH5)) jRadioButton5.setSelected(true);
      else if (ch_code.equals(CH6)) jRadioButton6.setSelected(true);
      else if (ch_code.equals(CH7)) jRadioButton7.setSelected(true);
      else if (ch_code.equals(CH8)) jRadioButton8.setSelected(true);
      else if (ch_code.equals(CH9)) jRadioButton9.setSelected(true);
  ...
  private void OK_button_actionPerformed(
    ...
    if (jRadioButton1.isSelected() == true) ch_code = CH1;
    else if (jRadioButton2.isSelected() == true) ch_code = CH2;
    else if (jRadioButton3.isSelected() == true) ch_code = CH3;
    else if (jRadioButton4.isSelected() == true) ch_code = CH4;
    else if (jRadioButton5.isSelected() == true) ch_code = CH5;
    else if (jRadioButton6.isSelected() == true) ch_code = CH6;
    else if (jRadioButton7.isSelected() == true) ch_code = CH7;
    else if (jRadioButton8.isSelected() == true) ch_code = CH8;
    else if (jRadioButton9.isSelected() == true) ch_code = CH9;
    else if (jRadioButton10.isSelected() == true) ch_code = CH0;
    else if (jRadioButton11.isSelected() == true) ch_code = "";
    else ch_code = "";
  ...
  private final String CH_HELP_DIR = "ch.pdf";
  private final String CH1_HELP_DIR = "ch_1.pdf";
  private final String CH2_HELP_DIR = "ch_2.pdf";
  private final String CH3_HELP_DIR = "ch_3.pdf";
  private final String CH4_HELP_DIR = "ch_4.pdf";
  private final String CH5_HELP_DIR = "ch_5.pdf";
  private final String CH6_HELP_DIR = "ch_6.pdf";
  private final String CH7_HELP_DIR = "ch_7.pdf";
  private final String CH8_HELP_DIR = "ch_8.pdf";
  private final String CH9_HELP_DIR = "ch_9.pdf";
