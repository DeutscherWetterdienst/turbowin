...
public class DASHBOARD_view_APR_radar extends javax.swing.JFrame {
  ...
  public class HitLinkMouseListener
      extends MouseAdapter // https://docs.oracle.com/javase/tutorial/displayCode.html?code=https://docs.oracle.com/javase/tutorial/2d/advanced/examples/HitTestSample.java
  {
  ...
  private void save_ship_dashboard_selection() {
    ...
    if (DASHBOARD_view_APR_radar.deck_color != null) {
      main.ship_deck_color_String =
          Integer.toString(DASHBOARD_view_APR_radar.deck_color.getRGB()); // save color as String
    }

    if (DASHBOARD_view_APR_radar.tank_color != null) {
      main.ship_tank_color_String =
          Integer.toString(DASHBOARD_view_APR_radar.tank_color.getRGB()); // save color as String
    }
  ...
  private void initComponents1()
      ...
      {
    // if autmatically opened (pop-up request thicked, see TurboWin+ APR maintenance menu) set this
    // APR radar dashboard always on top, but NOT if manually opened!
      ...
      try {
        ...
        try {
          ...
          main.log_turbowin_system_message(
              "[GENERAL] pop-up APR dashboard: error mouse move for deactivating screensaver ("
                  + e.getCause().toString()
                  + ")");
        }
      } // try
        ...
        main.log_turbowin_system_message(
            "[GENERAL] pop-up APR dashboard: there is no permission to set the value of the always-on-top property ("
    ...
    // System.out.println("+++ 1) [initComponets1() mywind.int_true_wind_speed = "+
    // mywind.int_true_wind_speed);

    // set
    wind_input_APR_from_main_form_or_previous =
        true; // then no consistency checks (via itemStateChanged() e.g. if a radiobutton is
    // selected here below)
    ...
    if ((main.wind_source.equals(main.ESTIMATED_TRUE))
      ...
      if (mywind.int_true_wind_dir == main.INVALID) {
        ...
        int tmp_wind_dir =
            (int) (Math.round(mywind.int_true_wind_dir / 10.0) * 10); // round to tens!
    ...
    if (main.theme_mode.equals(main.THEME_NIMBUS_NIGHT)) {
      ...
      // background_color_panel1 = jPanel1.getBackground();
      background_color_panel1 =
          jPanel4.getBackground(); // jPanel4 = West panel (but could also be another (site)panel)
    ...
    menuItem3_container_color_various.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_light_blue.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_blue.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_dark_blue.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_magenta.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem3_container_color_maroon.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem13_container_color_various.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_VARIOUS;
    ...
    menuItem13_container_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_WHITE;
    ...
    menuItem13_container_color_light_blue.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_LIGHT_BLUE;
    ...
    menuItem13_container_color_blue.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_BLUE;
    ...
    menuItem13_container_color_dark_blue.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_DARK_BLUE;
    ...
    menuItem13_container_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_GREEN;
    ...
    menuItem13_container_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_GRAY;
    ...
    menuItem13_container_color_magenta.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_MAGENTA;
    ...
    menuItem13_container_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_YELLOW;
    ...
    menuItem13_container_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_ORANGE;
    ...
    menuItem13_container_color_maroon.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = ship.CONTAINER_COLOR_MAROON;
    ...
    menuItem4_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem4_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem28_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_BROWN;
    ...
    menuItem28_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_RED_BROWN;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_RED;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_GREEN; // green-blue
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_LIGHT_GREEN;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_ORANGE;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_YELLOW;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_GRAY_BROWN;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_GRAY;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_LIGHT_GRAY;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_DARK_GRAY;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem28_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            DASHBOARD_view_APR_radar.deck_color = DECK_COLOR_BLUE_GRAY;
            main.ship_type_dashboard = main.BULK_CARRIER_2;
            save_ship_dashboard_selection();
            repaint();
          }
    ...
    menuItem5_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem5_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem5_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem5_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem5_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem5_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem5_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem5_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem5_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem5_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem5_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem5_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    JMenuItem menuItem6_deck_color_brown_tank_color_red =
        new JMenuItem("deck color brown, tanks red");
    menuItem6.add(menuItem6_deck_color_brown_tank_color_red);

    menuItem6_deck_color_brown_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    JMenuItem menuItem6_deck_color_red_brown_tank_color_red =
        new JMenuItem("deck color red-brown, tanks red");
    menuItem6.add(menuItem6_deck_color_red_brown_tank_color_red);

    menuItem6_deck_color_red_brown_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem6_deck_color_red_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    JMenuItem menuItem6_deck_color_green_tank_color_red =
        new JMenuItem("deck color green, tanks red");
    menuItem6.add(menuItem6_deck_color_green_tank_color_red);

    menuItem6_deck_color_green_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    JMenuItem menuItem6_deck_color_light_green_tank_color_red =
        new JMenuItem("deck color light-green, tanks red");
    menuItem6.add(menuItem6_deck_color_light_green_tank_color_red);

    menuItem6_deck_color_light_green_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    JMenuItem menuItem6_deck_color_gray_brown_tank_color_red =
        new JMenuItem("deck color gray-brown, tanks red");
    menuItem6.add(menuItem6_deck_color_gray_brown_tank_color_red);

    menuItem6_deck_color_gray_brown_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    JMenuItem menuItem6_deck_color_gray_tank_color_red =
        new JMenuItem("deck color gray, tanks red");
    menuItem6.add(menuItem6_deck_color_gray_tank_color_red);

    menuItem6_deck_color_gray_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    JMenuItem menuItem6_deck_color_light_gray_tank_color_red =
        new JMenuItem("deck color light-gray, tanks red");
    menuItem6.add(menuItem6_deck_color_light_gray_tank_color_red);

    menuItem6_deck_color_light_gray_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    JMenuItem menuItem6_deck_color_dark_gray_tank_color_red =
        new JMenuItem("deck color dark-gray, tanks red");
    menuItem6.add(menuItem6_deck_color_dark_gray_tank_color_red);

    menuItem6_deck_color_dark_gray_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    JMenuItem menuItem6_deck_color_blue_gray_tank_color_red =
        new JMenuItem("deck color blue-gray, tanks red");
    menuItem6.add(menuItem6_deck_color_blue_gray_tank_color_red);

    menuItem6_deck_color_blue_gray_tank_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    JMenuItem menuItem6_deck_color_brown_tank_color_white =
        new JMenuItem("deck color brown, tanks white");
    menuItem6.add(menuItem6_deck_color_brown_tank_color_white);

    menuItem6_deck_color_brown_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    JMenuItem menuItem6_deck_color_red_brown_tank_color_white =
        new JMenuItem("deck color red-brown, tanks white");
    menuItem6.add(menuItem6_deck_color_red_brown_tank_color_white);

    menuItem6_deck_color_red_brown_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    JMenuItem menuItem6_deck_color_red_tank_color_white =
        new JMenuItem("deck color red, tanks white");
    menuItem6.add(menuItem6_deck_color_red_tank_color_white);

    menuItem6_deck_color_red_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    JMenuItem menuItem6_deck_color_green_tank_color_white =
        new JMenuItem("deck color green, tanks white");
    menuItem6.add(menuItem6_deck_color_green_tank_color_white);

    menuItem6_deck_color_green_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    JMenuItem menuItem6_deck_color_light_green_tank_color_white =
        new JMenuItem("deck color light-green, tanks white");
    menuItem6.add(menuItem6_deck_color_light_green_tank_color_white);

    menuItem6_deck_color_light_green_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    JMenuItem menuItem6_deck_color_gray_brown_tank_color_white =
        new JMenuItem("deck color gray-brown, tanks white");
    menuItem6.add(menuItem6_deck_color_gray_brown_tank_color_white);

    menuItem6_deck_color_gray_brown_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    JMenuItem menuItem6_deck_color_gray_tank_color_white =
        new JMenuItem("deck color gray, tanks white");
    menuItem6.add(menuItem6_deck_color_gray_tank_color_white);

    menuItem6_deck_color_gray_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    JMenuItem menuItem6_deck_color_light_gray_tank_color_white =
        new JMenuItem("deck color light-gray, tanks white");
    menuItem6.add(menuItem6_deck_color_light_gray_tank_color_white);

    menuItem6_deck_color_light_gray_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    JMenuItem menuItem6_deck_color_dark_gray_tank_color_white =
        new JMenuItem("deck color dark-gray, tanks white");
    menuItem6.add(menuItem6_deck_color_dark_gray_tank_color_white);

    menuItem6_deck_color_dark_gray_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    JMenuItem menuItem6_deck_color_blue_gray_tank_color_white =
        new JMenuItem("deck color blue-gray, tanks white");
    menuItem6.add(menuItem6_deck_color_blue_gray_tank_color_white);

    menuItem6_deck_color_blue_gray_tank_color_white.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    menuItem17_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem17_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem17_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem17_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem17_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem17_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem17_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem17_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem17_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem17_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem17_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem17_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    menuItem9_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem9_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem9_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem9_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem9_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem9_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem9_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem9_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem9_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem9_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem9_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem9_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    menuItem16_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem16_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem16_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem16_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem16_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem16_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem16_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem16_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem16_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem16_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem16_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem16_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    menuItem24_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem24_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem24_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem24_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem24_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem24_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem24_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem24_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem24_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem24_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem24_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem24_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    menuItem25_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem25_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem25_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem25_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem25_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem25_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem25_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem25_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem25_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem25_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem25_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem25_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    menuItem26_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem26_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem26_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem26_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem26_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem26_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem26_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem26_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem26_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem26_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem26_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem26_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    //////////////////////// tall ship /////////////////
    //
    JMenu menuItem19 = new JMenu("tall ship");
    popup.add(menuItem19);

    JMenuItem menuItem19_full_rigged_3 = new JMenuItem("full-rigged, 3 masts");
    menuItem19.add(menuItem19_full_rigged_3);

    menuItem19_full_rigged_3.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    JMenuItem menuItem19_full_rigged_4 = new JMenuItem("full-rigged, 4 masts");
    menuItem19.add(menuItem19_full_rigged_4);

    menuItem19_full_rigged_4.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    JMenuItem menuItem19_full_rigged_5 = new JMenuItem("full-rigged, 5 masts");
    menuItem19.add(menuItem19_full_rigged_5);

    menuItem19_full_rigged_5.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    JMenuItem menuItem19_barque_3 = new JMenuItem("barque, 3 masts");
    menuItem19.add(menuItem19_barque_3);

    menuItem19_barque_3.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    JMenuItem menuItem19_barque_4 = new JMenuItem("barque, 4 masts");
    menuItem19.add(menuItem19_barque_4);

    menuItem19_barque_4.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    JMenuItem menuItem19_barque_5 = new JMenuItem("barque, 5 masts");
    menuItem19.add(menuItem19_barque_5);

    menuItem19_barque_5.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem23_deck_color_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BROWN;
    ...
    menuItem23_deck_color_red_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED_BROWN;
    ...
    menuItem23_deck_color_red.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_RED;
    ...
    menuItem23_deck_color_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GREEN; // green-blue
    ...
    menuItem23_deck_color_light_green.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GREEN;
    ...
    menuItem23_deck_color_orange.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_ORANGE;
    ...
    menuItem23_deck_color_yellow.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_YELLOW;
    ...
    menuItem23_deck_color_gray_brown.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY_BROWN;
    ...
    menuItem23_deck_color_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_GRAY;
    ...
    menuItem23_deck_color_light_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_LIGHT_GRAY;
    ...
    menuItem23_deck_color_dark_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_DARK_GRAY;
    ...
    menuItem23_deck_color_blue_gray.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            deck_color = DECK_COLOR_BLUE_GRAY;
    ...
    menuItem1100.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    menuItem1101.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            int result =
    ...
    // NB see below, otherwise if you select Dashboard -> APR for the second, third or xth time it
    // wil first display the situation
  ...
  private void init_dashboard_APR_radar_timer() {
    ...
    ActionListener update_dashboard_APR_radar_action =
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    dashboard_update_APR_timer =
        new Timer(DELAY_UPDATE_APR_RADAR_SENSOR_LOOP, update_dashboard_APR_radar_action);
    dashboard_update_APR_timer.setRepeats(true); // false = only one action
    dashboard_update_APR_timer.setInitialDelay(
        INITIAL_DELAY_UPDATE_APR_RADAR_SENSOR_LOOP); // time in millisec to wait after timer is
    // started to fire first event
  ...
  private void initComponents() {
    ...
    jRadioButton10.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    jRadioButton11.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    jRadioButton12.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    jRadioButton13.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    jRadioButton14.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    jPanel6Layout.linkSize(
        javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel16, jLabel17});
        ...
        jPanel5Layout
            ...
            .addGroup(
                jPanel5Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 674, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanel3Layout
            ...
            .addGroup(
                ...
                jPanel3Layout
                    ...
                    .addGap(160, 160, 160)
                    .addComponent(
                        jButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
                    .addGap(160, 160, 160)
                    .addComponent(
                        jLabel1,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
  ...
  private void DASHBOARD_APR_view_radar_componentResizedHandler(
    ...
    width_APR_radar_dashboard =
        jPanel1.getWidth()
            + jPanel5.getWidth()
            - jPanel4
                .getWidth(); // center panel + east panel (NB east panel is with the manual input
    // data)
    height_APR_radar_dashboard = jPanel1.getHeight();

    System.out.println(
        "--- APR Dashboard wind radar (jPanel1 + jPanel5 - jPanel4) size = "
            + width_APR_radar_dashboard);
  ...
  private boolean check_wind_consistency_APR() {
    ...
    if (!wind_input_APR_from_main_form_or_previous) // NB in case wind input from main screen or a
    // previous APR dashboard input the checks were
    // all ready performed in mywind.java !
    {
      // general check
      //
      if (main.wind_source.equals("")) {
        // JOptionPane.showMessageDialog(null, "'wind speed units source' not selected (select:
        // Maintenance -> Station data)", main.APPLICATION_NAME, JOptionPane.WARNING_MESSAGE);
      ...
      */
      ...
      //
      if ((beaufort_class_APR >= 0)
          && (beaufort_class_APR <= 12)) // so there was a beaufort class selected
      {
        if ((wind_dir_APR.trim().equals("variable"))
            && ((beaufort_class_APR != 1) && (beaufort_class_APR != 2))) {
          // JOptionPane.showMessageDialog(null, "if wind direction is variable, wind force must be
          // < 3 Bf", main.APPLICATION_NAME, JOptionPane.WARNING_MESSAGE);
          int error_no = 2;
          write_Bf_error_message(error_no);
        ...
        if ((wind_dir_APR.trim().equals("calm"))
            && ((beaufort_class_APR >= 1) && (beaufort_class_APR <= 12))) {
          // JOptionPane.showMessageDialog(null, "if wind direction is calm, wind force must be 0
          // Bf", main.APPLICATION_NAME, JOptionPane.WARNING_MESSAGE);
      ...
      {
        if ((beaufort_class_APR == 0)
            && ((wind_dir_APR.trim().equals("variable")
                || (mywind.int_true_wind_dir > 0 && mywind.int_true_wind_dir <= 360)))) {
          // JOptionPane.showMessageDialog(null, "if wind force is 0 Bf, wind direction must be
          // calm", main.APPLICATION_NAME, JOptionPane.WARNING_MESSAGE);
  ...
  private void compute_wind_APR()
    ...
    // System.out.println("+++++++++++ wind_input_APR_from_main_form_or_previous = " +
    // wind_input_APR_from_main_form_or_previous);
    ...
    if (!wind_input_APR_from_main_form_or_previous) {
      ...
      if (checks_ok) {
        ...
        } else if ((mywind.int_true_wind_speed >= 100)
            && (mywind.int_true_wind_speed
                <= 200)) // NB due to the conversion from BF12 -> m/s or knots he probably never
        // gets here
        {
          mywind.ff_code = "99";
    ...
    DASHBOARD_view_APR_radar.jLabel21.setText(
        "true wind: " + show_wind_dir + "\u00B0 " + show_wind_speed + " " + show_units);
  ...
  public static void enable_disable_wind_controls_APR_radar(boolean mode) {
    ...
    // NB if wind is not estimated or not measured TRUE then make no changes to the default (see
    // initComponents1()[DASHBOARD_view_APR_radar.java]) disabled situation
    if ((main.wind_source.equals(main.ESTIMATED_TRUE))
        || (main.wind_source.equals(main.MEASURED_TRUE))) {
      if (mode == false) // no visual obs (xx.00 hr - xx.30 hr)
      {
  ...
  private void compute_relative_wind_APR_old() {
    ...
    */
    ...
    // V = velocity (boat speed over ground, always => 0)                   // SOG_APR_wind (FM13) /
    // SOG_SPR (format #101)
    ...
    if ((mywind.int_true_wind_speed >= 0.0 && mywind.int_true_wind_speed <= 400.0)
      ...
      relative_wind_dir_APR =
          Integer.toString((int) Math.round(beta)); // double rounding then -> int then -> String
  ...
  private void make_obs_actionPerformed(
    ...
    this.setAlwaysOnTop(
        false); // reset APR pop-up dashboard option to 'NOT aways on top', otherwise main screen
    // cannot be opened this way
    // System.out.println("--- APR Dashboard (re)set to 'NOT Always On Top'");

    if (main.mainClass != null) {
      if ((turbowin.main.ICONIFIED & main.mainClass.getExtendedState())
          == turbowin.main.ICONIFIED) {
  ...
  private void DASHBOARD_view_APR_windowClosed(
    ...
    main.dashboard_was_automatically_opened =
  ...
  private void DASHBOARD_view_APR_windowClosing(
    ...
    //    this function will not be called if this window is automatically closed by the system [via
    // main.dashboard_form_APR_radar.dispose()]

    // NB flag (boolean) "in_dashboard_pop_up_period" is set in Function:
    // RS232_And_WiFi_init_new_sensor_data_received_check_timer() [RS232_RS422.java]
    //

    if (main.in_dashboard_pop_up_period == true) {
      main.dashboard_was_manually_closed_in_dashboard_pop_up_period =
          true; // for option augmenation pop-up window in APR mode
    } else {
      main.dashboard_was_manually_closed_in_dashboard_pop_up_period =
          false; // for option augmenation pop-up window in APR mode
    }
  ...
  private void write_Bf_error_message(int error_no) {
    ...
    if (error_no == 1) {
      ...
      // JOptionPane.showMessageDialog(null, "if wind direction is variable, wind force must be < 3
      // Bf", main.APPLICATION_NAME, JOptionPane.WARNING_MESSAGE);
      jLabel5.setText("if wind direction is variable,");
      jLabel6.setText("wind force must be 1 or 2 Bf");

    } else if (error_no == 3) {
      // JOptionPane.showMessageDialog(null, "if wind direction is calm, wind force must be 0 Bf",
      ...
      // System.out.println("+++++++++++ write_Bf_error_message() jLabel5.getText() = " +
      // jLabel5.getText());
      // System.out.println("+++++++++++ write_Bf_error_message() jLabel6.getText() = " +
      // jLabel6.getText());
    } else if (error_no == 4) {
      // JOptionPane.showMessageDialog(null, "if wind force is 0 Bf, wind direction must be calm",
      // main.APPLICATION_NAME, JOptionPane.WARNING_MESSAGE);
  ...
  private int convert_bf_to_knots(int Bf_class)
    ...
    switch (Bf_class) {
      case 0:
        true_wind_speed_knots = Bf0_kts;
        break;
      case 1:
        true_wind_speed_knots = Bf1_kts;
        break;
      case 2:
        true_wind_speed_knots = Bf2_kts;
        break;
      case 3:
        true_wind_speed_knots = Bf3_kts;
        break;
      case 4:
        true_wind_speed_knots = Bf4_kts;
        break;
      case 5:
        true_wind_speed_knots = Bf5_kts;
        break;
      case 6:
        true_wind_speed_knots = Bf6_kts;
        break;
      case 7:
        true_wind_speed_knots = Bf7_kts;
        break;
      case 8:
        true_wind_speed_knots = Bf8_kts;
        break;
      case 9:
        true_wind_speed_knots = Bf9_kts;
        break;
      case 10:
        true_wind_speed_knots = Bf10_kts;
        break;
      case 11:
        true_wind_speed_knots = Bf11_kts;
        break;
      case 12:
        true_wind_speed_knots = Bf12_kts;
        break;
      default:
        true_wind_speed_knots = main.INVALID;
        break;
    } // switch
  ...
  private int convert_bf_to_m_s(int Bf_class) {
    ...
    switch (Bf_class) {
      case 0:
        true_wind_speed_m_s = Bf0_ms;
        break;
      case 1:
        true_wind_speed_m_s = Bf1_ms;
        break;
      case 2:
        true_wind_speed_m_s = Bf2_ms;
        break;
      case 3:
        true_wind_speed_m_s = Bf3_ms;
        break;
      case 4:
        true_wind_speed_m_s = Bf4_ms;
        break;
      case 5:
        true_wind_speed_m_s = Bf5_ms;
        break;
      case 6:
        true_wind_speed_m_s = Bf6_ms;
        break;
      case 7:
        true_wind_speed_m_s = Bf7_ms;
        break;
      case 8:
        true_wind_speed_m_s = Bf8_ms;
        break;
      case 9:
        true_wind_speed_m_s = Bf9_ms;
        break;
      case 10:
        true_wind_speed_m_s = Bf10_ms;
        break;
      case 11:
        true_wind_speed_m_s = Bf11_ms;
        break;
      case 12:
        true_wind_speed_m_s = Bf12_ms;
        break;
      default:
        true_wind_speed_m_s = main.INVALID;
        break;
    } // switch
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(DASHBOARD_view_APR_radar.class.getName())
  ...
  private final int DELAY_UPDATE_APR_RADAR_SENSOR_LOOP =
      60000; // 1 min                 // time in millisec to wait after timer is started to fire
  // first event (10 min = 10 * 1000 * 60 * 10 = 600000)
  private final int INITIAL_DELAY_UPDATE_APR_RADAR_SENSOR_LOOP =
      0; // 1000 = 1 sec              // time in millisec to wait after timer is started to fire
  // first event
  ...
  private final Color DECK_COLOR_LIGHT_GREEN =
      new Color(0, 204, 102); // MUST BE THE SAME AS IN ship.java
  ...
  public static int beaufort_class_APR =
      main.INVALID; // for the correct background photo of the radar screen
  public static String wind_dir_APR = "";

  public static int relative_beaufort_class_APR =
      main.INVALID; // for the correct background photo of the radar screen
  public static String relative_wind_dir_APR = "";
  public static boolean wind_input_APR_from_main_form_or_previous =
      false; // for yes/no perform the consistency_checks
