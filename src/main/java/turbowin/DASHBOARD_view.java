...
public class DASHBOARD_view extends javax.swing.JFrame {
  ...
  public DASHBOARD_view() {
    ...
    if (main.theme_mode.equals(main.THEME_TRANSPARENT)) {
      // NB before, by invoking initComponents1(),  most of the main start-up settings were already
      // done
  ...
  private void initComponents() {
    ...
    */ jPanel1 = new DASHBOARD_grafiek();
            ...
            .addGroup(
                jPanel4Layout
                    ...
                    .addComponent(
                        ...
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED, 85, Short.MAX_VALUE)
                    .addComponent(
                        jLabel4,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
                        469,
    ...
    jLabel1.setText(
        "--- black indicator arrow indicates the pressure at last update, white set hand indicates the pressure 3 hours earlier ---");
  ...
  private void initComponents1() {
    ...
    menuItem1100.addActionListener(
        new java.awt.event.ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            choose_dashboard_image_barometer(); // NB will also be saved in configuration.txt here
    ...
    // NB see below, otherwise if you select Dashboard -> Barometer for the second, third or xth
    // time it wil first display the situation
  ...
  private void choose_dashboard_image_barometer() {
    ...
    if (doorgaan == true) {
      ...
      int result = chooser.showOpenDialog(DASHBOARD_view.this);
  ...
  private void Dashboard_componentResizedHandler(
    ...
    // TODO add your handling code here:
    System.out.println(
        "--- Barometer Dashboard (jPanel1) size = " + DASHBOARD_view.jPanel1.getSize());
  ...
  private void init_dasboard_timer() {
    ...
    ActionListener update_dashboard_action =
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            main_RS232_RS422.RS232_read_dasboard_values();
    ...
    dashboard_update_timer.setInitialDelay(
        INITIAL_DELAY_UPDATE_SENSOR_LOOP); // time in millisec to wait after timer is started to
    // fire first event
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(DASHBOARD_view.class.getName())
  ...
  private final int INITIAL_DELAY_UPDATE_SENSOR_LOOP =
      30000; // 1000 = 1 sec                   // time in millisec to wait after timer is started to
  // fire first event
